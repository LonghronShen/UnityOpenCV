...
namespace OpenCvSharp
{
    ...
    public class CvSeq : CvTreeNode<CvSeq>, ICloneable
    {
        ...
        public CvSeq(SeqType seq_flags, int elem_size, CvMemStorage storage)
            : this(seq_flags, SizeOf, elem_size, storage)
        {
        }
#if LANG_JP
        /// <summary>
        ...
        {
            Cv.SeqInsertSlice(this, before_index, from_arr);
        }
        #endregion
        #region Invert
#if LANG_JP
        ...
        {
            T result;
            Cv.SeqPopFront<T>(this, out result);
            return result;
        }
        #endregion
        #region PopMulti
        ...
        {
            T[] elements;
            Cv.SeqPopMulti<T>(this, out elements, count, in_front);
            return elements;
        }
        #endregion
        #region Push
        ...
        {
            return Cv.SeqSearch(this, elem, func, is_sorted, out elem_idx);
        }
        #endregion
        #region SetBlockSize
#if LANG_JP
        ...
        {
            Cv.SetSeqBlockSize(this, delta_elems);
        }
        #endregion
        #region Slice
#if LANG_JP
