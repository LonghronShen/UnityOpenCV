...
namespace OpenCvSharp
{
    partial class CvArr
    {
...
#endif
        public void AdaptiveThreshold(CvArr dst, double max_value)
        {
            Cv.AdaptiveThreshold(this, dst, max_value);
        }
#if LANG_JP
        /// <summary>
        /// 適応的な閾値処理を行い、グレースケール画像を2値画像に変換する
...
#endif
        public void AdaptiveThreshold(CvArr dst, double max_value, AdaptiveThresholdType adaptive_method)
        {
            Cv.AdaptiveThreshold(this, dst, max_value, adaptive_method);
        }
#if LANG_JP
        /// <summary>
        /// 適応的な閾値処理を行い、グレースケール画像を2値画像に変換する
...
#endif
        public void AdaptiveThreshold(CvArr dst, double max_value, AdaptiveThresholdType adaptive_method, ThresholdType threshold_type)
        {
            Cv.AdaptiveThreshold(this, dst, max_value, adaptive_method, threshold_type);
        }
#if LANG_JP
        /// <summary>
        /// 適応的な閾値処理を行い、グレースケール画像を2値画像に変換する
...
#endif
        public void AdaptiveThreshold(CvArr dst, double max_value, AdaptiveThresholdType adaptive_method, ThresholdType threshold_type, Int32 block_size)
        {
            Cv.AdaptiveThreshold(this, dst, max_value, adaptive_method, threshold_type, block_size);
        }
#if LANG_JP
        /// <summary>
        /// 適応的な閾値処理を行い、グレースケール画像を2値画像に変換する
...
#endif
        public void AdaptiveThreshold(CvArr dst, double max_value, AdaptiveThresholdType adaptive_method, ThresholdType threshold_type, int block_size, double param1)
        {
            Cv.AdaptiveThreshold(this, dst, max_value, adaptive_method, threshold_type, block_size, param1);
        }
        #endregion
        #region Add
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public double ArcLength(CvSlice slice, int is_closed)
        {
            return Cv.ArcLength(this, slice, is_closed);
        }
        #endregion
        #region Avg
#if LANG_JP
...
#endif
        public void AvgSdv(out CvScalar mean, out CvScalar std_dev)
        {
            Cv.AvgSdv(this, out mean, out std_dev, null);
        }
#if LANG_JP
        /// <summary>
        /// 配列要素の平均と標準偏差を各チャンネルで独立に計算する．
        ...
        /// <param name="mask">The optional operation mask. </param>
#endif
        public void AvgSdv(out CvScalar mean, out CvScalar std_dev, CvArr mask)
        {
            Cv.AvgSdv(this, out mean, out std_dev, mask);
        }
        #endregion
        #region BoundingRect
#if LANG_JP
...
#endif
        public void Canny(CvArr edges, double threshold1, double threshold2, ApertureSize aperture_size)
        {
            Cv.Canny(this, edges, threshold1, threshold2, aperture_size);
        }
        #endregion
        #region CheckArr
#if LANG_JP
        ...
        /// <returns>returns nonzero if the check succeeded, i.e. all elements are valid and within the range, and zero otherwise.</returns>
#endif
        public bool CheckArr(CheckArrFlag flags, double min_val, double max_val)
        {
            return Cv.CheckArr(this, flags, min_val, max_val);
        }
#if LANG_JP
        /// <summary>
        ...
        /// <returns>returns nonzero if the check succeeded, i.e. all elements are valid and within the range, and zero otherwise.</returns>
#endif
        public bool CheckArray(CheckArrFlag flags, double min_val, double max_val)
        {
            return Cv.CheckArray(this, flags, min_val, max_val);
        }
        #endregion
...
#endif
        public void Circle(int center_x, int center_y, int radius, CvScalar color)
        {
            Cv.Circle(this, center_x, center_y, radius, color);
        }
#if LANG_JP
        /// <summary>
        /// 円を描画する
...
#endif
        public void Circle(int center_x, int center_y, int radius, CvScalar color, int thickness)
        {
            Cv.Circle(this, center_x, center_y, radius, color, thickness);
        }
#if LANG_JP
        /// <summary>
        /// 円を描画する
...
#endif
        public void Circle(int center_x, int center_y, int radius, CvScalar color, int thickness, LineType line_type)
        {
            Cv.Circle(this, center_x, center_y, radius, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 円を描画する
...
#endif
        public void Circle(int center_x, int center_y, int radius, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.Circle(this, center_x, center_y, radius, color, thickness, line_type, shift);
        }
        ...
        /// <param name="line_type">Type of the circle boundary.</param>
#endif
        public void Circle(CvPoint center, int radius, CvScalar color, int thickness, LineType line_type)
        {
            Cv.Circle(this, center, radius, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 円を描画する
        ...
        /// <param name="shift">Number of fractional bits in the center coordinates and radius value. </param>
#endif
        public void Circle(CvPoint center, int radius, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.Circle(this, center, radius, color, thickness, line_type, shift);
        }
#if LANG_JP
        /// <summary>
        /// 円を描画する
        ...
        /// <param name="color">Circle color. </param>
#endif
        public void DrawCircle(int center_x, int center_y, int radius, CvScalar color)
        {
            Cv.DrawCircle(this, center_x, center_y, radius, color);
        }
#if LANG_JP
        /// <summary>
        /// 円を描画する
        ...
        /// <param name="thickness">Thickness of the circle outline if positive, otherwise indicates that a filled circle has to be drawn. </param>
#endif
        public void DrawCircle(int center_x, int center_y, int radius, CvScalar color, int thickness)
        {
            Cv.DrawCircle(this, center_x, center_y, radius, color, thickness);
        }
#if LANG_JP
        /// <summary>
        /// 円を描画する
        ...
        /// <param name="line_type">Type of the circle boundary.</param>
#endif
        public void DrawCircle(int center_x, int center_y, int radius, CvScalar color, int thickness, LineType line_type)
        {
            Cv.DrawCircle(this, center_x, center_y, radius, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 円を描画する
        ...
        /// <param name="shift">Number of fractional bits in the center coordinates and radius value. </param>
#endif
        public void DrawCircle(int center_x, int center_y, int radius, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.DrawCircle(this, center_x, center_y, radius, color, thickness, line_type, shift);
        }
        ...
        /// <param name="line_type">Type of the circle boundary.</param>
#endif
        public void DrawCircle(CvPoint center, int radius, CvScalar color, int thickness, LineType line_type)
        {
            Cv.DrawCircle(this, center, radius, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 円を描画する
        ...
        /// <param name="shift">Number of fractional bits in the center coordinates and radius value. </param>
#endif
        public void DrawCircle(CvPoint center, int radius, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.DrawCircle(this, center, radius, color, thickness, line_type, shift);
        }
        #endregion
        #region ClearND
#if LANG_JP
...
#endif
        public void Cmp(CvArr src2, CvArr dst, ArrComparison cmp_op)
        {
            Cv.Cmp(this, src2, dst, cmp_op);
        }
        #endregion
        #region CmpS
#if LANG_JP
        ...
        /// <param name="cmp_op">The flag specifying the relation between the elements to be checked</param>
#endif
        public void CmpS(double value, CvArr dst, ArrComparison cmp_op)
        {
            Cv.CmpS(this, value, dst, cmp_op);
        }
        #endregion
        #region ContourArea
#if LANG_JP
...
#endif
        public void CornerEigenValsAndVecs(CvArr eigenvv, int block_size)
        {
            Cv.CornerEigenValsAndVecs(this, eigenvv, block_size);
        }
#if LANG_JP
        /// <summary>
        /// コーナー検出のために画像ブロックの固有値と固有ベクトルを計算する.
        ...
        /// <param name="aperture_size">Aperture parameter for Sobel operator</param>
#endif
        public void CornerEigenValsAndVecs(CvArr eigenvv, int block_size, ApertureSize aperture_size)
        {
            Cv.CornerEigenValsAndVecs(this, eigenvv, block_size, aperture_size);
        }
        #endregion
        #region CornerHarris
#if LANG_JP
        ...
        /// <param name="block_size">Neighborhood size.</param>
#endif
        public void CornerHarris(CvArr harris_responce, int block_size)
        {
            Cv.CornerHarris(this, harris_responce, block_size);
        }
#if LANG_JP
        /// <summary>
        /// 入力画像について Harris エッジ検出を行う． 
...
#endif
        public void CornerHarris(CvArr harris_responce, int block_size, ApertureSize aperture_size)
        {
            Cv.CornerHarris(this, harris_responce, block_size, aperture_size);
        }
#if LANG_JP
        /// <summary>
        /// 入力画像について Harris エッジ検出を行う． 
...
#endif
        public void CornerHarris(CvArr harris_responce, int block_size, ApertureSize aperture_size, double k)
        {
            Cv.CornerHarris(this, harris_responce, block_size, aperture_size, k);
        }
        #endregion
        ...
        /// <param name="block_size">Neighborhood size.</param>
#endif
        public void CornerMinEigenVal(CvArr eigenval, int block_size)
        {
            Cv.CornerMinEigenVal(this, eigenval, block_size);
        }
#if LANG_JP
        /// <summary>
        /// コーナー検出のために，画像ブロックの最小固有値を計算する. 
        ...
        /// <param name="aperture_size">Aperture parameter for Sobel operator (see cvSobel). format. In the case of floating-point input format this parameter is the number of the fixed float filter used for differencing. </param>
#endif
        public void CornerMinEigenVal(CvArr eigenval, int block_size, ApertureSize aperture_size)
        {
            Cv.CornerMinEigenVal(this, eigenval, block_size, aperture_size);
        }
        #endregion
        #region CountNonZero
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public CvMat[] CreatePyramid(int extra_layers, double rate, CvSize[] layer_sizes, CvArr bufarr, bool calc, CvFilter filter)
        {
            return Cv.CreatePyramid(this, extra_layers, rate, layer_sizes, bufarr, calc, filter);
        }
        #endregion
        #region CrossProduct
#if LANG_JP
...
#endif
        public void DFT(CvArr dst, DFTFlag flags, int nonzero_rows)
        {
            Cv.DFT(this, dst, flags, nonzero_rows);
        }
#if LANG_JP
        /// <summary>
        ...
        /// <param name="nonzero_rows">Number of nonzero rows to in the source array (in case of forward 2d transform), or a number of rows of interest in the destination array (in case of inverse 2d transform). If the value is negative, zero, or greater than the total number of rows, it is ignored. The parameter can be used to speed up 2d convolution/correlation when computing them via DFT.</param>
#endif
        public void FFT(CvArr dst, DFTFlag flags, int nonzero_rows)
        {
            Cv.FFT(this, dst, flags, nonzero_rows);
        }
        #endregion
        #region Dilate
#if LANG_JP
...
#endif
        public void DistTransform(CvArr dst, DistanceType distance_type)
        {
            Cv.DistTransform(this, dst, distance_type);
        }
#if LANG_JP
        /// <summary>
        /// 入力画像中の値が0でないピクセルから，最も近い値が0のピクセルまでの距離を計算する
...
#endif
        public void DistTransform(CvArr dst, DistanceType distance_type, int mask_size)
        {
            Cv.DistTransform(this, dst, distance_type, mask_size);
        }
#if LANG_JP
        /// <summary>
        /// 入力画像中の値が0でないピクセルから，最も近い値が0のピクセルまでの距離を計算する
...
#endif
        public void DistTransform(CvArr dst, DistanceType distance_type, int mask_size, float[] mask)
        {
            Cv.DistTransform(this, dst, distance_type, mask_size, mask);
        }
#if LANG_JP
        /// <summary>
        /// 入力画像中の値が0でないピクセルから，最も近い値が0のピクセルまでの距離を計算する
...
#endif
        public void DistTransform(CvArr dst, DistanceType distance_type, int mask_size, float[] mask, CvArr labels)
        {
            Cv.DistTransform(this, dst, distance_type, mask_size, mask, labels);
        }
        #endregion
        #region Div
#if LANG_JP
...
#endif
        public void DrawChessboardCorners(CvSize pattern_size, CvPoint2D32f[] corners, bool pattern_was_found)
        {
            Cv.DrawChessboardCorners(this, pattern_size, corners, pattern_was_found);
        }
        #endregion
        #region DrawContours
#if LANG_JP
...
#endif
        public void DrawContours(CvSeq<CvPoint> contour, CvScalar external_color, CvScalar hole_color, int max_level)
        {
            Cv.DrawContours(this, contour, external_color, hole_color, max_level);
        }
#if LANG_JP
        /// <summary>
        /// 画像の外側輪郭線，または内側輪郭線を描画する
...
#endif
        public void DrawContours(CvSeq<CvPoint> contour, CvScalar external_color, CvScalar hole_color, int max_level, int thickness)
        {
            Cv.DrawContours(this, contour, external_color, hole_color, max_level, thickness);
        }
#if LANG_JP
        /// <summary>
        /// 画像の外側輪郭線，または内側輪郭線を描画する
...
#endif
        public void DrawContours(CvSeq<CvPoint> contour, CvScalar external_color, CvScalar hole_color, int max_level, int thickness, LineType line_type)
        {
            Cv.DrawContours(this, contour, external_color, hole_color, max_level, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 画像の外側輪郭線，または内側輪郭線を描画する
...
#endif
        public void DrawContours(CvSeq<CvPoint> contour, CvScalar external_color, CvScalar hole_color, int max_level, int thickness, LineType line_type, CvPoint offset)
        {
            Cv.DrawContours(this, contour, external_color, hole_color, max_level, thickness, line_type, offset);
        }
        #endregion
        #region EigenVV
#if LANG_JP
...
#endif
        public void Ellipse(CvPoint center, CvSize axes, double angle, double start_angle, double end_angle, CvScalar color)
        {
            Cv.Ellipse(this, center, axes, angle, start_angle, end_angle, color);
        }
#if LANG_JP
        /// <summary>
        /// 枠だけの楕円，楕円弧，もしくは塗りつぶされた扇形の楕円を描画する
...
#endif
        public void Ellipse(CvPoint center, CvSize axes, double angle, double start_angle, double end_angle, CvScalar color, int thickness)
        {
            Cv.Ellipse(this, center, axes, angle, start_angle, end_angle, color, thickness);
        }
#if LANG_JP
        /// <summary>
        /// 枠だけの楕円，楕円弧，もしくは塗りつぶされた扇形の楕円を描画する
...
#endif
        public void Ellipse(CvPoint center, CvSize axes, double angle, double start_angle, double end_angle, CvScalar color, int thickness, LineType line_type)
        {
            Cv.Ellipse(this, center, axes, angle, start_angle, end_angle, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 枠だけの楕円，楕円弧，もしくは塗りつぶされた扇形の楕円を描画する
...
#endif
        public void Ellipse(CvPoint center, CvSize axes, double angle, double start_angle, double end_angle, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.Ellipse(this, center, axes, angle, start_angle, end_angle, color, thickness, line_type, shift);
        }
#if LANG_JP
        /// <summary>
        /// 枠だけの楕円，楕円弧，もしくは塗りつぶされた扇形の楕円を描画する
        ...
        /// <param name="color">Ellipse color. </param>
#endif
        public void DrawEllipse(CvPoint center, CvSize axes, double angle, double start_angle, double end_angle, CvScalar color)
        {
            Cv.DrawEllipse(this, center, axes, angle, start_angle, end_angle, color);
        }
#if LANG_JP
        /// <summary>
        /// 枠だけの楕円，楕円弧，もしくは塗りつぶされた扇形の楕円を描画する
        ...
        /// <param name="thickness">Thickness of the ellipse arc. </param>
#endif
        public void DrawEllipse(CvPoint center, CvSize axes, double angle, double start_angle, double end_angle, CvScalar color, int thickness)
        {
            Cv.DrawEllipse(this, center, axes, angle, start_angle, end_angle, color, thickness);
        }
#if LANG_JP
        /// <summary>
        /// 枠だけの楕円，楕円弧，もしくは塗りつぶされた扇形の楕円を描画する
        ...
        /// <param name="line_type">Type of the ellipse boundary.</param>
#endif
        public void DrawEllipse(CvPoint center, CvSize axes, double angle, double start_angle, double end_angle, CvScalar color, int thickness, LineType line_type)
        {
            Cv.DrawEllipse(this, center, axes, angle, start_angle, end_angle, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 枠だけの楕円，楕円弧，もしくは塗りつぶされた扇形の楕円を描画する
        ...
        /// <param name="shift">Number of fractional bits in the center coordinates and axes' values. </param>
#endif
        public void DrawEllipse(CvPoint center, CvSize axes, double angle, double start_angle, double end_angle, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.DrawEllipse(this, center, axes, angle, start_angle, end_angle, color, thickness, line_type, shift);
        }
        #endregion
        #region EllipseBox
#if LANG_JP
        ...
        /// <param name="line_type">Type of the ellipse boundary</param>
#endif
        public void EllipseBox(CvBox2D box, CvScalar color, int thickness, LineType line_type)
        {
            Cv.EllipseBox(this, box, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 枠だけの楕円，もしくは塗りつぶされた楕円を描画する
...
#endif
        public void EllipseBox(CvBox2D box, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.EllipseBox(this, box, color, thickness, line_type, shift);
        }
        #endregion
        #region EqualizeHist
#if LANG_JP
...
#endif
        public void ExtractSURF(CvArr mask, out CvSeq<CvSURFPoint> keypoints, out CvSeq<float> descriptors, CvMemStorage storage, CvSURFParams param)
        {
...
#endif
        public void FillConvexPoly(CvPoint[] pts, CvScalar color, LineType line_type)
        {
            Cv.FillConvexPoly(this, pts, color, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 凸ポリゴンの内部を塗りつぶす．
...
#endif
        public void FillConvexPoly(CvPoint[] pts, CvScalar color, LineType line_type, int shift)
        {
            Cv.FillConvexPoly(this, pts, color, line_type, shift);
        }
        #endregion
        #region FillPoly
#if LANG_JP
...
#endif
        public void FillPoly(CvPoint[][] pts, CvScalar color, LineType line_type)
        {
            Cv.FillPoly(this, pts, color, line_type);
        }
#if LANG_JP
        /// <summary>
        /// ポリゴン内部を塗りつぶす
        ...
        /// <param name="shift">Number of fractional bits in the vertex coordinates. </param>
#endif
        public void FillPoly(CvPoint[][] pts, CvScalar color, LineType line_type, int shift)
        {
            Cv.FillPoly(this, pts, color, line_type, shift);
        }
        #endregion
        #region Filter2D
#if LANG_JP
...
#endif
        public bool FindChessboardCorners(CvSize pattern_size, out CvPoint2D32f[] corners)
        {
            return Cv.FindChessboardCorners(this, pattern_size, out corners);
        }
#if LANG_JP
        /// <summary>
        /// 入力画像がチェスボードパターンであるかどうかを確認し，チェスボードの各コーナーの位置検出を試みる．
        ...
        /// <returns>returns true if all the corners have been found and they have been placed in a certain order (row by row, left to right in every row), otherwise, if the function fails to find all the corners or reorder them, it returns false. </returns>
#endif
        public bool FindChessboardCorners(CvSize pattern_size, out CvPoint2D32f[] corners, out int corner_count)
        {
            return Cv.FindChessboardCorners(this, pattern_size, out corners, out corner_count);
        }
#if LANG_JP
        /// <summary>
        /// 入力画像がチェスボードパターンであるかどうかを確認し，チェスボードの各コーナーの位置検出を試みる．
        ...
        /// <returns>returns true if all the corners have been found and they have been placed in a certain order (row by row, left to right in every row), otherwise, if the function fails to find all the corners or reorder them, it returns false. </returns>
#endif
        public bool FindChessboardCorners(CvSize pattern_size, out CvPoint2D32f[] corners, out int corner_count, ChessboardFlag flags)
        {
            return Cv.FindChessboardCorners(this, pattern_size, out corners, out corner_count, flags);
        }
        #endregion
        #region FindContours
#if LANG_JP
...
#endif
        public int FindContours(CvMemStorage storage, out CvSeq<CvPoint> first_contour)
        {
            return Cv.FindContours(this, storage, out first_contour);
        }
#if LANG_JP
        /// <summary>
        /// 2値画像中の輪郭を見つける
        ...
        /// <returns>The number of retrieved contours.</returns>
#endif
        public int FindContours(CvMemStorage storage, out CvSeq<CvPoint> first_contour, int header_size)
        {
            return Cv.FindContours(this, storage, out first_contour, header_size);
        }
#if LANG_JP
        /// <summary>
        /// 2値画像中の輪郭を見つける
        ...
        /// <returns>The number of retrieved contours.</returns>
#endif
        public int FindContours(CvMemStorage storage, out CvSeq<CvPoint> first_contour, int header_size, ContourRetrieval mode)
        {
            return Cv.FindContours(this, storage, out first_contour, header_size, mode);
        }
#if LANG_JP
        /// <summary>
        /// 2値画像中の輪郭を見つける
        ...
        /// <returns>The number of retrieved contours.</returns>
#endif
        public int FindContours(CvMemStorage storage, out CvSeq<CvPoint> first_contour, int header_size, ContourRetrieval mode, ContourChain method)
        {
            return Cv.FindContours(this, storage, out first_contour, header_size, mode, method);
        }
#if LANG_JP
        /// <summary>
        /// 2値画像中の輪郭を見つける
        ...
        /// <returns>The number of retrieved contours.</returns>
#endif
        public int FindContours(CvMemStorage storage, out CvSeq<CvPoint> first_contour, int header_size, ContourRetrieval mode, ContourChain method, CvPoint offset)
        {
            return Cv.FindContours(this, storage, out first_contour, header_size, mode, method, offset);
        }
        #endregion
...
#endif
        public void FindCornerSubPix(CvPoint2D32f[] corners, int count, CvSize win, CvSize zero_zone, CvTermCriteria criteria)
        {
            Cv.FindCornerSubPix(this, corners, count, win, zero_zone, criteria);
        }
        #endregion
        #region FitEllipse2
#if LANG_JP
...
#endif
        public void FitLine(DistanceType dist_type, double param, double reps, double aeps, float[] line)
        {
            Cv.FitLine(this, dist_type, param, reps, aeps, line);
        }
        #endregion
        #region Flip
#if LANG_JP
...
#endif
        public void Flip(CvArr dst, FlipMode flip_mode)
        {
            Cv.Flip(this, dst, flip_mode);
        }
#if LANG_JP
        /// <summary>
        ...
        /// <param name="flip_mode">Specifies how to flip the array.</param>
#endif
        public void Mirror(CvArr dst, FlipMode flip_mode)
        {
            Cv.Mirror(this, dst, flip_mode);
        }
        #endregion
        #region FloodFill
#if LANG_JP
...
#endif
        public void FloodFill(CvPoint seed_point, CvScalar new_val)
        {
            Cv.FloodFill(this, seed_point, new_val);
        }
#if LANG_JP
        /// <summary>
        /// 連結成分を指定した色で塗りつぶす
...
#endif
        public void FloodFill(CvPoint seed_point, CvScalar new_val, CvScalar lo_diff)
        {
            Cv.FloodFill(this, seed_point, new_val, lo_diff);
        }
#if LANG_JP
        /// <summary>
        /// 連結成分を指定した色で塗りつぶす
...
#endif
        public void FloodFill(CvPoint seed_point, CvScalar new_val, CvScalar lo_diff, CvScalar up_diff)
        {
            Cv.FloodFill(this, seed_point, new_val, lo_diff, up_diff);
        }
#if LANG_JP
        /// <summary>
        /// 連結成分を指定した色で塗りつぶす
...
#endif
        public void FloodFill(CvPoint seed_point, CvScalar new_val, CvScalar lo_diff, CvScalar up_diff, out CvConnectedComp comp)
        {
            Cv.FloodFill(this, seed_point, new_val, lo_diff, up_diff, out comp);
        }
#if LANG_JP
        /// <summary>
        /// 連結成分を指定した色で塗りつぶす
...
#endif
        public void FloodFill(CvPoint seed_point, CvScalar new_val, CvScalar lo_diff, CvScalar up_diff, out CvConnectedComp comp, int flags)
        {
            Cv.FloodFill(this, seed_point, new_val, lo_diff, up_diff, out comp, flags);
        }
#if LANG_JP
        /// <summary>
        /// 連結成分を指定した色で塗りつぶす
...
#endif
        public void FloodFill(CvPoint seed_point, CvScalar new_val, CvScalar lo_diff, CvScalar up_diff, out CvConnectedComp comp, int flags, CvArr mask)
        {
            Cv.FloodFill(this, seed_point, new_val, lo_diff, up_diff, out comp, flags, mask);
        }
        #endregion
        #region Get*D
#if LANG_JP
        ...
        {
            return CvInvoke.cvGet1D(this.CvPtr, idx0);
        }
#if LANG_JP
        /// <summary>
        /// 特定の配列要素を返す．
        ...
        {
            return CvInvoke.cvGet2D(this.CvPtr, idx0, idx1);
        }
#if LANG_JP
        /// <summary>
        /// 特定の配列要素を返す．
        ...
        {
            return CvInvoke.cvGet3D(this.CvPtr, idx0, idx1, idx2);
        }
#if LANG_JP
        /// <summary>
        /// 特定の配列要素を返す．
        ...
        {
            return CvInvoke.cvGetND(this.CvPtr, idx);
        }
        #endregion
        #region GetCol
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public CvMat GetCols(int start_col, int end_col)
        {
            CvMat submat;
            return Cv.GetCols(this, out submat, start_col, end_col);
        }
        #endregion
        #region GetDiag
#if LANG_JP
...
#endif
        public void GetQuadrangleSubPix(CvArr dst, CvMat map_matrix)
        {
            Cv.GetQuadrangleSubPix(this, dst, map_matrix);
        }
        #endregion
        #region GetRawData
#if LANG_JP
...
#endif
        public void GetRawData(out IntPtr data, out int step, out CvSize roi_size)
        {
            Cv.GetRawData(this, out data, out step, out roi_size);
        }
        #endregion
        #region GetReal*D
#if LANG_JP
        ...
        {
            return CvInvoke.cvGetReal1D(this.CvPtr, idx0);
        }
#if LANG_JP
        /// <summary>
        /// シングルチャンネルの配列の特定の要素を返す．配列がマルチチャンネルの場合は，ランタイムエラーが発生する．
        ...
        {
            return CvInvoke.cvGetReal2D(this.CvPtr, idx0, idx1);
        }
#if LANG_JP
        /// <summary>
        /// シングルチャンネルの配列の特定の要素を返す．配列がマルチチャンネルの場合は，ランタイムエラーが発生する．
        ...
        {
            return CvInvoke.cvGetReal3D(this.CvPtr, idx0, idx1, idx2);
        }
#if LANG_JP
        /// <summary>
        /// シングルチャンネルの配列の特定の要素を返す．配列がマルチチャンネルの場合は，ランタイムエラーが発生する．
        ...
        {
            return CvInvoke.cvGetRealND(this.CvPtr, idx);
        }
        #endregion
        ...
        /// <returns></returns>
#endif
        public CvMat GetRows(int start_row, int end_row)
        {
            CvMat submat;
            return Cv.GetRows(this, out submat, start_row, end_row);
        }
#if LANG_JP
        /// <summary>
        /// 指定された範囲の行（複数行）を返す
        ...
        /// <returns></returns>
#endif
        public CvMat GetRows(int start_row, int end_row, int delta_row)
        {
            CvMat submat;
            return Cv.GetRows(this, out submat, start_row, end_row, delta_row);
        }
        #endregion
        #region GetSize
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvAvgComp> HaarDetectObjects(CvHaarClassifierCascade cascade, CvMemStorage storage, double scale_factor)
        {
            return Cv.HaarDetectObjects(this, cascade, storage, scale_factor);
        }
#if LANG_JP
        /// <summary>
        /// 与えられた画像からオブジェクトを含む様な矩形領域を検出し，それらの領域を矩形の列として返す．
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvAvgComp> HaarDetectObjects(CvHaarClassifierCascade cascade, CvMemStorage storage, double scale_factor, int min_neighbors)
        {
            return Cv.HaarDetectObjects(this, cascade, storage, scale_factor, min_neighbors);
        }
#if LANG_JP
        /// <summary>
        /// 与えられた画像からオブジェクトを含む様な矩形領域を検出し，それらの領域を矩形の列として返す．
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvAvgComp> HaarDetectObjects(CvHaarClassifierCascade cascade, CvMemStorage storage, double scale_factor, int min_neighbors, HaarDetectionType flags)
        {
            return Cv.HaarDetectObjects(this, cascade, storage, scale_factor, min_neighbors, flags);
        }
#if LANG_JP
        /// <summary>
        /// 与えられた画像からオブジェクトを含む様な矩形領域を検出し，それらの領域を矩形の列として返す．
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvAvgComp> HaarDetectObjects(CvHaarClassifierCascade cascade, CvMemStorage storage, double scale_factor, int min_neighbors, HaarDetectionType flags, CvSize min_size)
        {
            return Cv.HaarDetectObjects(this, cascade, storage, scale_factor, min_neighbors, flags, min_size);
        }
        #endregion
        #region HoughCircles
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvCircleSegment> HoughCircles(CvMemStorage circle_storage, HoughCirclesMethod method, double dp, double min_dist)
        {
            return Cv.HoughCircles(this, circle_storage, method, dp, min_dist);
        }
#if LANG_JP
        /// <summary>
        /// ハフ変換を用いてグレースケール画像中の円を検出する
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvCircleSegment> HoughCircles(CvMemStorage circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1)
        {
            return Cv.HoughCircles(this, circle_storage, method, dp, min_dist, param1);
        }
#if LANG_JP
        /// <summary>
        /// ハフ変換を用いてグレースケール画像中の円を検出する
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvCircleSegment> HoughCircles(CvMemStorage circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1, double param2)
        {
            return Cv.HoughCircles(this, circle_storage, method, dp, min_dist, param1, param2);
        }
#if LANG_JP
        /// <summary>
        /// ハフ変換を用いてグレースケール画像中の円を検出する
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvCircleSegment> HoughCircles(CvMemStorage circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1, double param2, int min_radius)
        {
            return Cv.HoughCircles(this, circle_storage, method, dp, min_dist, param1, param2, min_radius);
        }
#if LANG_JP
        /// <summary>
        /// ハフ変換を用いてグレースケール画像中の円を検出する
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvCircleSegment> HoughCircles(CvMemStorage circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1, double param2, int min_radius, int max_radius)
        {
            return Cv.HoughCircles(this, circle_storage, method, dp, min_dist, param1, param2, min_radius, max_radius);
        }
        #endregion
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvCircleSegment> HoughCircles(CvMat circle_storage, HoughCirclesMethod method, double dp, double min_dist)
        {
            return Cv.HoughCircles(this, circle_storage, method, dp, min_dist);
        }
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvCircleSegment> HoughCircles(CvMat circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1)
        {
            return Cv.HoughCircles(this, circle_storage, method, dp, min_dist, param1);
        }
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvCircleSegment> HoughCircles(CvMat circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1, double param2)
        {
            return Cv.HoughCircles(this, circle_storage, method, dp, min_dist, param1, param2);
        }
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvCircleSegment> HoughCircles(CvMat circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1, double param2, int min_radius)
        {
            return Cv.HoughCircles(this, circle_storage, method, dp, min_dist, param1, param2, min_radius);
        }
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvCircleSegment> HoughCircles(CvMat circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1, double param2, int min_radius, int max_radius)
        {
            return Cv.HoughCircles(this, circle_storage, method, dp, min_dist, param1, param2, min_radius);
        }
        #endregion
        ...
        /// <returns></returns>
#endif
        public CvSeq HoughLines2(CvMemStorage line_storage, HoughLinesMethod method, double rho, double theta, int threshold)
        {
            return Cv.HoughLines2(this, line_storage, method, rho, theta, threshold);
        }
#if LANG_JP
        /// <summary>
        /// ハフ（Hough）変換を用いて2値画像から直線を検出する
        ...
        /// <returns></returns>
#endif
        public CvSeq HoughLines2(CvMemStorage line_storage, HoughLinesMethod method, double rho, double theta, int threshold, double param1, double param2)
        {
            return Cv.HoughLines2(this, line_storage, method, rho, theta, threshold, param1, param2);
        }
#if LANG_JP
        /// <summary>
        /// ハフ（Hough）変換を用いて2値画像から直線を検出する
        ...
        /// <returns></returns>
#endif
        public CvSeq HoughLines2(CvMat line_storage, HoughLinesMethod method, double rho, double theta, int threshold)
        {
            return Cv.HoughLines2(this, line_storage, method, rho, theta, threshold, 0, 0);
        }
#if LANG_JP
        /// <summary>
        /// ハフ（Hough）変換を用いて2値画像から直線を検出する
        ...
        /// <returns></returns>
#endif
        public CvSeq HoughLines2(CvMat line_storage, HoughLinesMethod method, double rho, double theta, int threshold, double param1, double param2)
        {
            return Cv.HoughLines2(this, line_storage, method, rho, theta, threshold, param1, param2);
        }
        #endregion
...
#endif
        public void Integral(CvArr sum, CvArr sqsum, CvArr tilted_sum)
        {
            Cv.Integral(this, sum, sqsum, tilted_sum);
        }
        #endregion
        #region Invert
#if LANG_JP
...
#endif
        public void KMeans2(int cluster_count, CvArr labels, CvTermCriteria termcrit)
        {
            Cv.KMeans2(this, cluster_count, labels, termcrit);
        }
        #endregion
        #region Laplace
#if LANG_JP
...
#endif
        public void Laplace(CvArr dst, ApertureSize aperture_size)
        {
            Cv.Laplace(this, dst, aperture_size);
        }
        #endregion
        #region Line
#if LANG_JP
...
#endif
        public void Line(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color)
        {
            Cv.Line(this, pt1_x, pt1_y, pt2_x, pt2_y, color);
        }
#if LANG_JP
        /// <summary>
        /// 2点を結ぶ線分を画像上に描画する．
...
#endif
        public void Line(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness)
        {
            Cv.Line(this, pt1_x, pt1_y, pt2_x, pt2_y, color, thickness);
        }
#if LANG_JP
        /// <summary>
        /// 2点を結ぶ線分を画像上に描画する．
...
#endif
        public void Line(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type)
        {
            Cv.Line(this, pt1_x, pt1_y, pt2_x, pt2_y, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 2点を結ぶ線分を画像上に描画する．
...
#endif
        public void Line(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.Line(this, pt1_x, pt1_y, pt2_x, pt2_y, color, thickness, line_type, shift);
        }
        ...
        /// <param name="line_type">Type of the line.</param>
#endif
        public void Line(CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type)
        {
            Cv.Line(this, pt1, pt2, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 2点を結ぶ線分を画像上に描画する．
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public void Line(CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.Line(this, pt1, pt2, color, thickness, line_type, shift);
        }
#if LANG_JP
        /// <summary>
        /// 2点を結ぶ線分を画像上に描画する．
        ...
        /// <param name="color">Line color. </param>
#endif
        public void DrawLine(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color)
        {
            Cv.DrawLine(this, pt1_x, pt1_y, pt2_x, pt2_y, color);
        }
#if LANG_JP
        /// <summary>
        /// 2点を結ぶ線分を画像上に描画する．
        ...
        /// <param name="thickness">Line thickness. </param>
#endif
        public void DrawLine(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness)
        {
            Cv.DrawLine(this, pt1_x, pt1_y, pt2_x, pt2_y, color, thickness);
        }
#if LANG_JP
        /// <summary>
        /// 2点を結ぶ線分を画像上に描画する．
        ...
        /// <param name="line_type">Type of the line.</param>
#endif
        public void DrawLine(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type)
        {
            Cv.DrawLine(this, pt1_x, pt1_y, pt2_x, pt2_y, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 2点を結ぶ線分を画像上に描画する．
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public void DrawLine(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.DrawLine(this, pt1_x, pt1_y, pt2_x, pt2_y, color, thickness, line_type, shift);
        }
        ...
        /// <param name="line_type">Type of the line.</param>
#endif
        public void DrawLine(CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type)
        {
            Cv.DrawLine(this, pt1, pt2, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 2点を結ぶ線分を画像上に描画する．
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public void DrawLine(CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.DrawLine(this, pt1, pt2, color, thickness, line_type, shift);
        }
        #endregion
        #region LinearPolar
#if LANG_JP
...
#endif
        public void MinMaxLoc(out double min_val, out double max_val)
        {
            Cv.MinMaxLoc(this, out min_val, out max_val);
        }
#if LANG_JP
        /// <summary>
        /// 配列あるいは部分配列内の最小値と最大値を求める
...
#endif
        public void MinMaxLoc(out double min_val, out double max_val, CvArr mask)
        {
            Cv.MinMaxLoc(this, out min_val, out max_val, mask);
        }
#if LANG_JP
        /// <summary>
        /// 配列あるいは部分配列内の最小値と最大値を求める
...
#endif
        public void MinMaxLoc(out CvPoint min_loc, out CvPoint max_loc)
        {
            Cv.MinMaxLoc(this, out min_loc, out max_loc);
        }
#if LANG_JP
        /// <summary>
        /// 配列あるいは部分配列内の最小値と最大値を求める
        ...
        /// <param name="mask">The optional mask that is used to select a subarray. </param>
#endif
        public void MinMaxLoc(out CvPoint min_loc, out CvPoint max_loc, CvArr mask)
        {
            Cv.MinMaxLoc(this, out min_loc, out max_loc, mask);
        }
#if LANG_JP
        /// <summary>
        /// 配列あるいは部分配列内の最小値と最大値を求める
        ...
        /// <param name="max_loc">Pointer to returned maximum location. </param>
#endif
        public void MinMaxLoc(out double min_val, out double max_val, out CvPoint min_loc, out CvPoint max_loc)
        {
            Cv.MinMaxLoc(this, out min_val, out max_val, out min_loc, out max_loc);
        }
#if LANG_JP
        /// <summary>
        /// 配列あるいは部分配列内の最小値と最大値を求める
        ...
        /// <param name="mask">The optional mask that is used to select a subarray. </param>
#endif
        public void MinMaxLoc(out double min_val, out double max_val, out CvPoint min_loc, out CvPoint max_loc, CvArr mask)
        {
            Cv.MinMaxLoc(this, out min_val, out max_val, out min_loc, out max_loc, mask);
        }
        #endregion
        #region MinS
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public double Norm(CvArr arr2, NormType norm_type)
        {
            return Cv.Norm(this, arr2, norm_type);
        }
#if LANG_JP
        /// <summary>
        /// 配列の絶対値ノルム（absolute array norm），絶対値差分ノルム（absolute difference norm），相対値差分ノルム（relative difference norm）を計算する
        ...
        /// <returns></returns>
#endif
        public double Norm(CvArr arr2, NormType norm_type, CvArr mask)
        {
            return Cv.Norm(this, arr2, norm_type, mask);
        }
        #endregion
        #region Normalize
#if LANG_JP
...
#endif
        public void Normalize(CvArr dst, double a, double b, NormType norm_type)
        {
            Cv.Normalize(this, dst, a, b, norm_type);
        }
#if LANG_JP
        /// <summary>
        /// 指定のノルムになるように，あるいは値が指定の範囲になるように，配列を正規化する
...
#endif
        public void Normalize(CvArr dst, double a, double b, NormType norm_type, CvArr mask)
        {
             Cv.Normalize(this, dst, a, b, norm_type, mask);
        }
        #endregion
        #region Not
#if LANG_JP
...
#endif
        public double PointPolygonTest(CvPoint2D32f pt, bool measure_dist)
        {
            return Cv.PointPolygonTest(this, pt, measure_dist);
        }
        #endregion
        #region PolyLine
#if LANG_JP
...
#endif
        public void PolyLine(CvPoint[][] pts, bool is_closed, CvScalar color)
        {
            Cv.PolyLine(this, pts, is_closed, color);
        }
#if LANG_JP
        /// <summary>
        /// ポリライン（枠だけのポリゴン）を描画する
...
#endif
        public void PolyLine(CvPoint[][] pts, bool is_closed, CvScalar color, int thickness)
        {
            Cv.PolyLine(this, pts, is_closed, color, thickness);
        }
#if LANG_JP
        /// <summary>
        /// ポリライン（枠だけのポリゴン）を描画する
...
#endif
        public void PolyLine(CvPoint[][] pts, bool is_closed, CvScalar color, int thickness, LineType line_type)
        {
            Cv.PolyLine(this, pts, is_closed, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// ポリライン（枠だけのポリゴン）を描画する
        ...
        /// <param name="shift">Number of fractional bits in the vertex coordinates. </param>
#endif
        public void PolyLine(CvPoint[][] pts, bool is_closed, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.PolyLine(this, pts, is_closed, color, thickness, line_type, shift);
        }
#if LANG_JP
        /// <summary>
        /// ポリライン（枠だけのポリゴン）を描画する
        ...
        /// <param name="color">Polyline color. </param>
#endif
        public void DrawPolyLine(CvPoint[][] pts, bool is_closed, CvScalar color)
        {
            Cv.DrawPolyLine(this, pts, is_closed, color);
        }
#if LANG_JP
        /// <summary>
        /// ポリライン（枠だけのポリゴン）を描画する
        ...
        /// <param name="thickness">Thickness of the polyline edges. </param>
#endif
        public void DrawPolyLine(CvPoint[][] pts, bool is_closed, CvScalar color, int thickness)
        {
            Cv.DrawPolyLine(this, pts, is_closed, color, thickness);
        }
#if LANG_JP
        /// <summary>
        /// ポリライン（枠だけのポリゴン）を描画する
        ...
        /// <param name="line_type">Type of the line segments.</param>
#endif
        public void DrawPolyLine(CvPoint[][] pts, bool is_closed, CvScalar color, int thickness, LineType line_type)
        {
            Cv.DrawPolyLine(this, pts, is_closed, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// ポリライン（枠だけのポリゴン）を描画する
        ...
        /// <param name="shift">Number of fractional bits in the vertex coordinates. </param>
#endif
        public void DrawPolyLine(CvPoint[][] pts, bool is_closed, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.DrawPolyLine(this, pts, is_closed, color, thickness, line_type, shift);
        }
        #endregion
        #region Pow
#if LANG_JP
        ...
        /// <param name="aperture_size">Aperture parameter for Sobel operator.</param>
#endif
        public void PreCornerDetect(CvArr corners, ApertureSize aperture_size)
        {
            Cv.PreCornerDetect(this, corners, aperture_size);
        }
        #endregion
        #region Ptr*D
#if LANG_JP
        ...
        /// <returns>pointer to the particular array element</returns>
#endif
        public IntPtr PtrND(int[] idx, out MatrixType type, bool create_node)
        {
            return Cv.PtrND(this, idx, out type, create_node);
        }
#if LANG_JP
        /// <summary>
        /// 特定の配列要素へのポインタを返す．
        ...
        /// <returns>pointer to the particular array element</returns>
#endif
        public IntPtr PtrND(int[] idx, out MatrixType type, bool create_node, uint? precalc_hashval)
        {
            return Cv.PtrND(this, idx, out type, create_node, precalc_hashval);
        }
        #endregion
        #region PutText
#if LANG_JP
        ...
        {
            Cv.PyrMeanShiftFiltering(this, dst, sp, sr, max_level);
        }
#if LANG_JP
        /// <summary>
        /// 平均値シフト法による画像のセグメント化アルゴリズムのフィルタリング部分を実装する．
        ...
        {
            Cv.PyrMeanShiftFiltering(this, dst, sp, sr, max_level, termcrit);
        }
        #endregion
        #region PyrUp
#if LANG_JP
...
#endif
        public void RandShuffle(CvRNG rng, double iter_factor)
        {
            Cv.RandShuffle(this, rng, iter_factor);
        }
        #endregion
        #region Range
#if LANG_JP
...
#endif
        public void Rectangle(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color)
        {
            Cv.Rectangle(this, pt1_x, pt1_y, pt2_x, pt2_y, color);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
...
#endif
        public void Rectangle(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness)
        {
            Cv.Rectangle(this, pt1_x, pt1_y, pt2_x, pt2_y, color, thickness);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
...
#endif
        public void Rectangle(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type)
        {
            Cv.Rectangle(this, pt1_x, pt1_y, pt2_x, pt2_y, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public void Rectangle(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.Rectangle(this, pt1_x, pt1_y, pt2_x, pt2_y, color, thickness, line_type, shift);
        }
        ...
        /// <param name="line_type">Type of the line, see cvLine description. </param>
#endif
        public void Rectangle(CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type)
        {
            Cv.Rectangle(this, pt1, pt2, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public void Rectangle(CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.Rectangle(this, pt1, pt2, color, thickness, line_type, shift);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
        ...
        /// <param name="line_type">Type of the line, see cvLine description. </param>
#endif
        public void Rectangle(CvRect rect, CvScalar color, int thickness, LineType line_type)
        {
            Cv.Rectangle(this, rect, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public void Rectangle(CvRect rect, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.Rectangle(this, rect, color, thickness, line_type, shift);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
        ...
        /// <param name="color">Line color (RGB) or brightness (grayscale image). </param>
#endif
        public void DrawRect(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color)
        {
            Cv.DrawRect(this, pt1_x, pt1_y, pt2_x, pt2_y, color);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
        ...
        /// <param name="thickness">Thickness of lines that make up the rectangle. Negative values, e.g. CV_FILLED, make the function to draw a filled rectangle. </param>
#endif
        public void DrawRect(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness)
        {
            Cv.DrawRect(this, pt1_x, pt1_y, pt2_x, pt2_y, color, thickness);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
        ...
        /// <param name="line_type">Type of the line, see cvLine description. </param>
#endif
        public void DrawRect(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type)
        {
            Cv.DrawRect(this, pt1_x, pt1_y, pt2_x, pt2_y, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public void DrawRect(int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.DrawRect(this, pt1_x, pt1_y, pt2_x, pt2_y, color, thickness, line_type, shift);
        }
        ...
        /// <param name="line_type">Type of the line, see cvLine description. </param>
#endif
        public void DrawRect(CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type)
        {
            Cv.DrawRect(this, pt1, pt2, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public void DrawRect(CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.DrawRect(this, pt1, pt2, color, thickness, line_type, shift);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
        ...
        /// <param name="line_type">Type of the line, see cvLine description. </param>
#endif
        public void DrawRect(CvRect rect, CvScalar color, int thickness, LineType line_type)
        {
            Cv.DrawRect(this, rect, color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public void DrawRect(CvRect rect, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Cv.DrawRect(this, rect, color, thickness, line_type, shift);
        }
        #endregion
        #region Reduce
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public CvMat Reshape(out CvMat header, int new_cn)
        {
            return Cv.Reshape(this, out header, new_cn);
        }
#if LANG_JP
        /// <summary>
        /// オリジナルの配列と同じデータだが，異なる形状（異なるチャンネル数，異なる行数，またその両方）を持つCvMatのヘッダを初期化する．
        ...
        /// <returns></returns>
#endif
        public CvMat Reshape(out CvMat header, int new_cn, int new_rows)
        {
            return Cv.Reshape(this, out header, new_cn, new_rows);
        }
#if LANG_JP
        /// <summary>
        /// オリジナルの配列と同じデータだが，異なる形状（異なるチャンネル数，異なる行数，またその両方）を持つCvMatのヘッダを初期化する．
        ...
        /// <returns></returns>
#endif
        public CvMat Reshape(CvMat header, int new_cn)
        {
            return Cv.Reshape(this, header, new_cn);
        }
#if LANG_JP
        /// <summary>
        /// オリジナルの配列と同じデータだが，異なる形状（異なるチャンネル数，異なる行数，またその両方）を持つCvMatのヘッダを初期化する．
        ...
        /// <returns></returns>
#endif
        public CvMat Reshape(CvMat header, int new_cn, int new_rows)
        {
            return Cv.Reshape(this, header, new_cn, new_rows);
        }
        #endregion
        #region ReshapeMatND
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public T ReshapeMatND<T>(int sizeof_header, T header, int new_cn, int new_dims, int[] new_sizes) where T : CvArr
        {
            return Cv.ReshapeMatND<T>(this, sizeof_header, header, new_cn, new_dims, new_sizes);
        }
#if LANG_JP
        /// <summary>
        /// cvReshape の拡張バージョン．
        ...
        /// <returns></returns>
#endif
        public T ReshapeND<T>(T header, int new_cn, int new_dims, int[] new_sizes) where T : CvArr
        {
            return Cv.ReshapeND<T>(this, header, new_cn, new_dims, new_sizes);
        }
        #endregion
        #region Resize
#if LANG_JP
        ...
        {
            CvInvoke.cvSet1D(this.CvPtr, idx0, value);
        }
#if LANG_JP
        /// <summary>
        /// 新しい値を指定した配列要素に割り当てる． 
        ...
        {
            CvInvoke.cvSet2D(this.CvPtr, idx0, idx1, value);
        }
#if LANG_JP
        /// <summary>
        /// 新しい値を指定した配列要素に割り当てる． 
        ...
        {
            CvInvoke.cvSet3D(this.CvPtr, idx0, idx1, idx2, value);
        }
#if LANG_JP
        /// <summary>
        /// 新しい値を指定した配列要素に割り当てる． 
        ...
        {
            CvInvoke.cvSetND(this.CvPtr, idx, value);
        }
        #endregion
        #region SetData
#if LANG_JP
        ...
        {
            CvInvoke.cvSetReal1D(this.CvPtr, idx0, value);
        }
#if LANG_JP
        /// <summary>
        /// シングルチャンネルの配列の指定した要素に新しい値を割り当てる．配列がマルチチャンネルのときは，ランタイムエラーが起こる．
        ...
        {
            CvInvoke.cvSetReal2D(this.CvPtr, idx0, idx1, value);
        }
#if LANG_JP
        /// <summary>
        /// シングルチャンネルの配列の指定した要素に新しい値を割り当てる．配列がマルチチャンネルのときは，ランタイムエラーが起こる．
        ...
        {
            CvInvoke.cvSetReal3D(this.CvPtr, idx0, idx1, idx2, value);
        }
#if LANG_JP
        /// <summary>
        /// シングルチャンネルの配列の指定した要素に新しい値を割り当てる．配列がマルチチャンネルのときは，ランタイムエラーが起こる．
        ...
        {
            CvInvoke.cvSetRealND(this.CvPtr, idx, value);
        }
        #endregion
        #region SetZero
#if LANG_JP
...
#endif
        public void Sobel(CvArr dst, int xorder, int yorder, ApertureSize aperture_size)
        {
            Cv.Sobel(this, dst, xorder, yorder, aperture_size);
        }
        #endregion
        #region Sort
#if LANG_JP
        ...
        /// <returns>CvContourScanner</returns>
#endif
        public CvContourScanner StartFindContours(CvMemStorage storage, int header_size)
        {
            return Cv.StartFindContours(this, storage, header_size);
        }
#if LANG_JP
        /// <summary>
        /// 輪郭走査処理の初期化を行う
        ...
        /// <returns>CvContourScanner</returns>
#endif
        public CvContourScanner StartFindContours(CvMemStorage storage, int header_size, ContourRetrieval mode)
        {
            return Cv.StartFindContours(this, storage, header_size, mode);
        }
#if LANG_JP
        /// <summary>
        /// 輪郭走査処理の初期化を行う
        ...
        /// <returns>CvContourScanner</returns>
#endif
        public CvContourScanner StartFindContours(CvMemStorage storage, int header_size, ContourRetrieval mode, ContourChain method)
        {
            return Cv.StartFindContours(this, storage, header_size, mode, method);
        }
#if LANG_JP
        /// <summary>
        /// 輪郭走査処理の初期化を行う
        ...
        /// <returns>CvContourScanner</returns>
#endif
        public CvContourScanner StartFindContours(CvMemStorage storage, int header_size, ContourRetrieval mode, ContourChain method, CvPoint offset)
        {
            return Cv.StartFindContours(this, storage, header_size, mode, method, offset);
        }
        #endregion
        #region Sub
#if LANG_JP
