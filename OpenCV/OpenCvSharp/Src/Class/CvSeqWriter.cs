...
namespace OpenCvSharp
{
    ...
    public class CvSeqWriter : DisposableCvObject
    {
            ...
            : this()
        {
            ...
            CvInvoke.cvStartAppendToSeq(seq.CvPtr, this._ptr);
        }
#if LANG_JP
        /// <summary>
            ...
            : this()
        {
            ...
            CvInvoke.cvStartWriteSeq(seq_flags, header_size, elem_size, storage.CvPtr, this._ptr);
        }
#if LANG_JP
        /// <summary>
        /// ポインタから初期化
        ...
        /// <param name="elem_ptr"></param>
#endif
        public void WRITE_SEQ_ELEM_VAR(IntPtr elem_ptr)
        {
            Cv.WRITE_SEQ_ELEM_VAR(elem_ptr, this);
        }
        #endregion
        #region WriteSeqElem
#if LANG_JP
