...
namespace OpenCvSharp
{
    ...
    public static class CvInvoke
    {
        ...
        [DllImport(DllImgproc, CallingConvention = CallingConvention.Cdecl)]
        public static extern float cvCalcEMD2(IntPtr signature1, IntPtr signature2, DistanceType distance_type, CvDistanceFunction distance_func,
