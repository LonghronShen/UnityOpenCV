...
namespace OpenCvSharp
{
    public static partial class Cv
    {
...
#endif
        public static void Laplace(CvArr src, CvArr dst, ApertureSize aperture_size)
        {
            if (src == null)
                throw new ArgumentNullException("src");
            if (dst == null)
                throw new ArgumentNullException("dst");
            CvInvoke.cvLaplace(src.CvPtr, dst.CvPtr, aperture_size);
        }
        #endregion
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvObjectDetection> LatentSvmDetectObjects(IplImage image, CvLatentSvmDetector detector, CvMemStorage storage, float overlap_threshold)
        {
            return LatentSvmDetectObjects(image, detector, storage, overlap_threshold, -1);
        }
#if LANG_JP
        /// <summary>
        /// find rectangular regions in the given image that are likely 
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvObjectDetection> LatentSvmDetectObjects(IplImage image, CvLatentSvmDetector detector, CvMemStorage storage, float overlap_threshold, int numThreads)
        {
            if (image == null)
            ...
            IntPtr p = CvInvoke.cvLatentSvmDetectObjects(image.CvPtr, detector.CvPtr, storage.CvPtr, overlap_threshold, numThreads);
            if (p == IntPtr.Zero)
                return null;
            else
...
#endif
        public static void Line(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color)
        {
            Line(img, new CvPoint(pt1_x, pt1_y), new CvPoint(pt2_x, pt2_y), color);
        }
#if LANG_JP
        /// <summary>
        /// 2点を結ぶ線分を画像上に描画する．
...
#endif
        public static void Line(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness)
        {
            Line(img, new CvPoint(pt1_x, pt1_y), new CvPoint(pt2_x, pt2_y), color, thickness);
        }
#if LANG_JP
        /// <summary>
        /// 2点を結ぶ線分を画像上に描画する．
...
#endif
        public static void Line(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type)
        {
            Line(img, new CvPoint(pt1_x, pt1_y), new CvPoint(pt2_x, pt2_y), color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 2点を結ぶ線分を画像上に描画する．
...
#endif
        public static void Line(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type, int shift)
        {
        ...
        /// <param name="line_type">Type of the line.</param>
#endif
        public static void Line(CvArr img, CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type)
        {
            Line(img, pt1, pt2, color, thickness, line_type, 0);
        }
#if LANG_JP
        /// <summary>
        /// 2点を結ぶ線分を画像上に描画する．
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public static void Line(CvArr img, CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type, int shift)
        {
            if (img == null)
            {
                throw new ArgumentNullException("img");
            }
            CvInvoke.cvLine(img.CvPtr, pt1, pt2, color, thickness, line_type, shift);
        }
#if LANG_JP
        /// <summary>
        /// 2点を結ぶ線分を画像上に描画する．
        ...
        /// <param name="color">Line color. </param>
#endif
        public static void DrawLine(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color)
        {
            Line(img, new CvPoint(pt1_x, pt1_y), new CvPoint(pt2_x, pt2_y), color);
        }
#if LANG_JP
        ...
        /// <param name="thickness">Line thickness. </param>
#endif
        public static void DrawLine(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness)
        {
            Line(img, new CvPoint(pt1_x, pt1_y), new CvPoint(pt2_x, pt2_y), color, thickness);
        }
#if LANG_JP
        ...
        /// <param name="line_type">Type of the line.</param>
#endif
        public static void DrawLine(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type)
        {
            Line(img, new CvPoint(pt1_x, pt1_y), new CvPoint(pt2_x, pt2_y), color, thickness, line_type);
        }
#if LANG_JP
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public static void DrawLine(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Line(img, new CvPoint(pt1_x, pt1_y), new CvPoint(pt2_x, pt2_y), color, thickness, line_type, shift);
        }
        ...
        /// <param name="line_type">Type of the line.</param>
#endif
        public static void DrawLine(CvArr img, CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type)
        {
            Line(img, pt1, pt2, color, thickness, line_type, 0);
        }
#if LANG_JP
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public static void DrawLine(CvArr img, CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type, int shift)
        {
        ...
        {
            string real_name;
            return Load<T>(filename, null, null, out real_name);
        }
#if LANG_JP
        /// <summary>
        /// オブジェクトをファイルから読み込む
        ...
        {
            string real_name;
            return Load<T>(filename, memstorage, null, out real_name);
        }
#if LANG_JP
        /// <summary>
        /// オブジェクトをファイルから読み込む
        ...
        {
            string real_name;
            return Load<T>(filename, memstorage, name, out real_name);
        }
#if LANG_JP
        /// <summary>
        /// オブジェクトをファイルから読み込む
        ...
        /// <param name="name">オブジェクト名（オプション）．nullの場合，ファイルストレージにある最初のトップレベルオブジェクトが読み込まれる． </param>
        /// <param name="real_name">読み込まれたオブジェクトの名前が代入される出力パラメータ（オプション）name=nullの場合に役立つ． </param>
        /// <returns>読み込んだオブジェクト</returns>
#else
        /// <summary>
        /// Loads object from file
        ...
        /// <returns>The function cvLoad loads object from file.</returns>
#endif
        public static T Load<T>(string filename, CvMemStorage memstorage, string name, out string real_name) where T : ICvPtrHolder
        {
            ...
            StringBuilder real_name_sb = new StringBuilder(1024);
            IntPtr result = CvInvoke.cvLoad(filename, memstoragePtr, name, real_name_sb);
            real_name = real_name_sb.ToString();
            try
            {
...
#endif
        [Obsolete]
        public static CvHaarClassifierCascade LoadHaarClassifierCascade(string directory, CvSize orig_window_size)
        {
            return CvHaarClassifierCascade.FromDirectory(directory, orig_window_size);
        }
        #endregion
        #region LoadImage
#if LANG_JP
        ...
        /// <param name="emax"></param>
#endif
        public static void LSHQuery(CvLSH lsh, CvMat query_points, CvMat indices, CvMat dist, int k, int emax)
        {
            if (lsh == null)
                throw new ArgumentNullException("lsh");
            if (query_points == null)
                throw new ArgumentNullException("query_points");
            if (indices == null)
                throw new ArgumentNullException("indices");
            if (dist == null)
                throw new ArgumentNullException("dist");
            CvInvoke.cvLSHQuery(lsh.CvPtr, query_points.CvPtr, indices.CvPtr, dist.CvPtr, k, emax);
        }
        #endregion
        #region LSHRemove
#if LANG_JP
