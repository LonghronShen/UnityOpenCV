...
namespace OpenCvSharp
{
    public static partial class Cv
    {
...
#endif
        public static void DFT(CvArr src, CvArr dst, DFTFlag flags, int nonzero_rows)
        {
            if (src == null)
                throw new ArgumentNullException("src");
            if (dst == null)
                throw new ArgumentNullException("dst");
            CvInvoke.cvDFT(src.CvPtr, dst.CvPtr, flags, nonzero_rows);
        }
#if LANG_JP
        /// <summary>
        ...
        /// <param name="nonzero_rows">Number of nonzero rows to in the source array (in case of forward 2d transform), or a number of rows of interest in the destination array (in case of inverse 2d transform). If the value is negative, zero, or greater than the total number of rows, it is ignored. The parameter can be used to speed up 2d convolution/correlation when computing them via DFT.</param>
#endif
        public static void FFT(CvArr src, CvArr dst, DFTFlag flags, int nonzero_rows)
        {
            DFT(src, dst, flags, nonzero_rows);
        }
        #endregion
        #region Dilate
#if LANG_JP
        ...
        public static void Dilate(CvArr src, CvArr dst, IplConvKernel element, int iterations)
        {
            ...
            CvInvoke.cvDilate(src.CvPtr, dst.CvPtr, elem_ptr, iterations);
        }
        #endregion
        ...
        {
            DistTransform(src, dst, DistanceType.L2, 3, null, null);
        }
#if LANG_JP
        /// <summary>
        /// 入力画像中の値が0でないピクセルから，最も近い値が0のピクセルまでの距離を計算する
...
#endif
        public static void DistTransform(CvArr src, CvArr dst, DistanceType distance_type)
        {
            DistTransform(src, dst, distance_type, 3, null, null);
        }
#if LANG_JP
        /// <summary>
        /// 入力画像中の値が0でないピクセルから，最も近い値が0のピクセルまでの距離を計算する
...
#endif
        public static void DistTransform(CvArr src, CvArr dst, DistanceType distance_type, int mask_size)
        {
            DistTransform(src, dst, distance_type, mask_size, null);
        }
#if LANG_JP
        /// <summary>
        /// 入力画像中の値が0でないピクセルから，最も近い値が0のピクセルまでの距離を計算する
...
#endif
        public static void DistTransform(CvArr src, CvArr dst, DistanceType distance_type, int mask_size, float[] mask)
        {
            DistTransform(src, dst, distance_type, mask_size, mask, null);
        }
#if LANG_JP
        /// <summary>
        /// 入力画像中の値が0でないピクセルから，最も近い値が0のピクセルまでの距離を計算する
...
#endif
        public static void DistTransform(CvArr src, CvArr dst, DistanceType distance_type, int mask_size, float[] mask, CvArr labels)
        {
            if (src == null)
                throw new ArgumentNullException("src");
            if (dst == null)
            ...
            CvInvoke.cvDistTransform(src.CvPtr, dst.CvPtr, distance_type, mask_size, mask, labelsPtr);
        }
        #endregion
        #region Div
#if LANG_JP
...
#endif
        public static void DrawChessboardCorners(CvArr image, CvSize pattern_size, CvPoint2D32f[] corners, bool pattern_was_found)
        {
            if (image == null)
                throw new ArgumentNullException("image");
            if (corners == null)
                throw new ArgumentNullException("corners");
            CvInvoke.cvDrawChessboardCorners(image.CvPtr, pattern_size, corners, corners.Length, pattern_was_found);
        }
        #endregion
        #region DrawContours
#if LANG_JP
...
#endif
        public static void DrawContours(CvArr img, CvSeq<CvPoint> contour, CvScalar external_color, CvScalar hole_color, int max_level)
        {
            DrawContours(img, contour, external_color, hole_color, max_level, 1, LineType.Link8, new CvPoint(0, 0));
        }
#if LANG_JP
        /// <summary>
        /// 画像の外側輪郭線，または内側輪郭線を描画する
...
#endif
        public static void DrawContours(CvArr img, CvSeq<CvPoint> contour, CvScalar external_color, CvScalar hole_color, int max_level, int thickness)
        {
            DrawContours(img, contour, external_color, hole_color, max_level, thickness, LineType.Link8, new CvPoint(0, 0));
        }
#if LANG_JP
        /// <summary>
        /// 画像の外側輪郭線，または内側輪郭線を描画する
...
#endif
        public static void DrawContours(CvArr img, CvSeq<CvPoint> contour, CvScalar external_color, CvScalar hole_color, int max_level, int thickness, LineType line_type)
        {
            DrawContours(img, contour, external_color, hole_color, max_level, thickness, line_type, new CvPoint(0, 0));
        }
#if LANG_JP
        /// <summary>
        /// 画像の外側輪郭線，または内側輪郭線を描画する
...
#endif
        public static void DrawContours(CvArr img, CvSeq<CvPoint> contour, CvScalar external_color, CvScalar hole_color, int max_level, int thickness, LineType line_type, CvPoint offset)
        {
            if (img == null)
                throw new ArgumentNullException("img");
            if (contour == null)
                throw new ArgumentNullException("contour");
            CvInvoke.cvDrawContours(img.CvPtr, contour.CvPtr, external_color, hole_color, max_level, thickness, line_type, offset);
        }
        #endregion
    }
}