...
namespace OpenCvSharp
{
    public static partial class Cv
    {
...
#endif
        public static void RandArr(CvRNG rng, CvArr arr, DistributionType dist_type, CvScalar param1, CvScalar param2)
        {
            if (rng == null)
                throw new ArgumentNullException("rng");
            if (arr == null)
                throw new ArgumentNullException("arr");
            UInt64 _rng = rng.Seed;
            CvInvoke.cvRandArr(ref _rng, arr.CvPtr, dist_type, param1, param2);
            rng.Seed = _rng;
        }
        #endregion
        #region RandInit
        ...
        /// <returns></returns>
#endif
        public static int RANSACUpdateNumIters(double p, double err_prob, int model_points, int max_iters)
        {
            return CvInvoke.cvRANSACUpdateNumIters(p, err_prob, model_points, max_iters);
        }
        #endregion
        #region RandSetRange
#if LANG_JP
...
#endif
        public static void RandShuffle(CvArr mat, CvRNG rng, double iter_factor)
        {
            if (mat == null)
            {
            ...
            {
                UInt64 _rng = 0;
                CvInvoke.cvRandShuffle(mat.CvPtr, ref _rng, iter_factor);
            }
            else
            {
                UInt64 _rng = rng.Seed;
        ...
        public static T Read<T>(CvFileStorage fs, CvFileNode node) where T : CvArr
        {
            ...
            else if (t == typeof(CvSparseMat))
                return (T)(object)(new CvSparseMat(result));
            else if (t == typeof(CvSeq))
        ...
        /// <returns>integer that is represented by the file node. If the file node is null, default_value is returned.</returns>
#endif
        public static int ReadInt(CvFileNode node, int default_value)
        {
            return (node == null) ? default_value 
                : Cv.NODE_IS_INT(node.Tag) ? node.DataI 
                : Cv.NODE_IS_REAL(node.Tag) ? Cv.Round(node.DataF) 
                : 0x7fffffff;
        }
        #endregion
        ...
        /// <returns></returns>
#endif
        public static int ReadIntByName(CvFileStorage fs, CvFileNode map, string name, int default_value)
        {
            if (fs == null)
            {
                throw new ArgumentNullException("fs");
        ...
        /// <returns>returns floating-point value that is represented by the file node. If the file node is null, default_value is returned.</returns>
#endif
        public static double ReadReal(CvFileNode node, double default_value)
        {
            return (node == null) ? default_value 
                : Cv.NODE_IS_INT(node.Tag) ? (double)node.DataI 
                : Cv.NODE_IS_REAL(node.Tag) ? node.DataF 
                : 1e300;
        }
        #endregion
        ...
        /// <returns></returns>
#endif
        public static double ReadRealByName(CvFileStorage fs, CvFileNode map, string name, double default_value)
        {
            if (fs == null)
            {
                throw new ArgumentNullException("fs");
        ...
        /// <returns>returns text string that is represented by the file node. If the file node is null, default_value is returned.</returns>
#endif
        public static string ReadString(CvFileNode node, string default_value)
        {
            return (node == null) ? default_value
                : Cv.NODE_IS_STRING(node.Tag) ? node.DataStr.ToString() 
                : null;
        }
        #endregion
        ...
        /// <returns></returns>
#endif
        public static string ReadStringByName(CvFileStorage fs, CvFileNode map, string name, string default_value)
        {
            if (fs == null)
            {
                throw new ArgumentNullException("fs");
...
#endif
        public static void Rectangle(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color)
        {
            Rectangle(img, new CvPoint(pt1_x, pt1_y), new CvPoint(pt2_x, pt2_y), color);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
...
#endif
        public static void Rectangle(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness)
        {
            Rectangle(img, new CvPoint(pt1_x, pt1_y), new CvPoint(pt2_x, pt2_y), color, thickness);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
...
#endif
        public static void Rectangle(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type)
        {
            Rectangle(img, new CvPoint(pt1_x, pt1_y), new CvPoint(pt2_x, pt2_y), color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
...
#endif
        public static void Rectangle(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type, int shift)
        {
        ...
        /// <param name="line_type">Type of the line, see cvLine description. </param>
#endif
        public static void Rectangle(CvArr img, CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type)
        {
            Rectangle(img, pt1, pt2, color, thickness, line_type, 0);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public static void Rectangle(CvArr img, CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type, int shift)
        {
            if (img == null)
            {
                throw new ArgumentNullException("img");
            }
            CvInvoke.cvRectangle(img.CvPtr, pt1, pt2, color, thickness, line_type, shift);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
        ...
        /// <param name="line_type">Type of the line, see cvLine description. </param>
#endif
        public static void Rectangle(CvArr img, CvRect rect, CvScalar color, int thickness, LineType line_type)
        {
            Rectangle(img, new CvPoint(rect.X, rect.Y), new CvPoint(rect.X + rect.Width, rect.Y + rect.Height), color, thickness, line_type);
        }
#if LANG_JP
        /// <summary>
        /// 枠のみ，もしくは塗りつぶされた矩形を描画する
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public static void Rectangle(CvArr img, CvRect rect, CvScalar color, int thickness, LineType line_type, int shift)
        {
        ...
        /// <param name="color">Line color (RGB) or brightness (grayscale image). </param>
#endif
        public static void DrawRect(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color)
        {
            Rectangle(img, new CvPoint(pt1_x, pt1_y), new CvPoint(pt2_x, pt2_y), color);
        }
#if LANG_JP
        ...
        /// <param name="thickness">Thickness of lines that make up the rectangle. Negative values, e.g. CV_FILLED, make the function to draw a filled rectangle. </param>
#endif
        public static void DrawRect(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness)
        {
            Rectangle(img, new CvPoint(pt1_x, pt1_y), new CvPoint(pt2_x, pt2_y), color, thickness);
        }
#if LANG_JP
        ...
        /// <param name="line_type">Type of the line, see cvLine description. </param>
#endif
        public static void DrawRect(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type)
        {
            Rectangle(img, new CvPoint(pt1_x, pt1_y), new CvPoint(pt2_x, pt2_y), color, thickness, line_type);
        }
#if LANG_JP
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public static void DrawRect(CvArr img, int pt1_x, int pt1_y, int pt2_x, int pt2_y, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Rectangle(img, new CvPoint(pt1_x, pt1_y), new CvPoint(pt2_x, pt2_y), color, thickness, line_type, shift);
        }
        ...
        /// <param name="line_type">Type of the line, see cvLine description. </param>
#endif
        public static void DrawRect(CvArr img, CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type)
        {
            Rectangle(img, pt1, pt2, color, thickness, line_type, 0);
        }
#if LANG_JP
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public static void DrawRect(CvArr img, CvPoint pt1, CvPoint pt2, CvScalar color, int thickness, LineType line_type, int shift)
        {
        ...
        /// <param name="line_type">Type of the line, see cvLine description. </param>
#endif
        public static void DrawRect(CvArr img, CvRect rect, CvScalar color, int thickness, LineType line_type)
        {
            Rectangle(img, new CvPoint(rect.X, rect.Y), new CvPoint(rect.X + rect.Width, rect.Y + rect.Height), color, thickness, line_type);
        }
#if LANG_JP
        ...
        /// <param name="shift">Number of fractional bits in the point coordinates. </param>
#endif
        public static void DrawRect(CvArr img, CvRect rect, CvScalar color, int thickness, LineType line_type, int shift)
        {
            Rectangle(img, new CvPoint(rect.X, rect.Y), new CvPoint(rect.X + rect.Width, rect.Y + rect.Height), color, thickness, line_type, shift);
        }
        #endregion
        ...
        /// </summary>
        /// <param name="posit_object">構造体 CvPOSIT への参照</param>
#else
        /// <summary>
...
#endif
        public static void ReleasePOSITObject(CvPOSITObject posit_object)
        {
            if (posit_object != null)
            {
                posit_object.Dispose();
            }
        }
        #endregion
