...
namespace OpenCvSharp
{
    public static partial class Cv
    {
        ...
        /// <returns></returns>
#endif
        public static CvTermCriteria TermCriteria(CriteriaType type, int max_iter, double epsilon)
        {
        ...
        public static void Threshold(CvArr src, CvArr dst, double threshold, double max_value, ThresholdType threshold_type)
        {
            ...
            CvInvoke.cvThreshold(src.CvPtr, dst.CvPtr, threshold, max_value, threshold_type);
        }
        #endregion
        #region Trace
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public static CvSeq TreeToNodeSeq<T>(CvTreeNode<T> first, int header_size, CvMemStorage storage)
            where T : CvTreeNode<T>
        {
            ...
            IntPtr result = CvInvoke.cvTreeToNodeSeq(first.CvPtr, header_size, storage);
        ...
        /// <returns></returns>
#endif
        public static CvTypeInfo TypeOf(IntPtr struct_ptr)
        {
            IntPtr result = CvInvoke.cvTypeOf(struct_ptr);
            if (result == IntPtr.Zero)
                return null;
            else
                return new CvTypeInfo(struct_ptr);
        }
#if LANG_JP
        /// <summary>
        /// オブジェクトの型を返す
        ...
        /// <returns></returns>
#endif
        public static CvTypeInfo TypeOf(ICvPtrHolder struct_ptr)
        {
            return TypeOf(struct_ptr.CvPtr);
        }
        #endregion
    }
}