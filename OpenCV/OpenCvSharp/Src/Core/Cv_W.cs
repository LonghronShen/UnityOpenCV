...
namespace OpenCvSharp
{
    public static partial class Cv
    {
        ...
        /// <returns>key code</returns>
#endif
        public static int WaitKey(Int32 delay)
        {
...
#endif
        public static void WarpAffine(CvArr src, CvArr dst, CvMat map_matrix)
        {
            WarpAffine(src, dst, map_matrix, Interpolation.Linear | Interpolation.FillOutliers, CvScalar.ScalarAll(0));
        }
#if LANG_JP
        /// <summary>
        /// 画像のアフィン変換を行う
...
#endif
        public static void WarpAffine(CvArr src, CvArr dst, CvMat map_matrix, Interpolation flags)
        {
            WarpAffine(src, dst, map_matrix, flags, CvScalar.ScalarAll(0));
        }
#if LANG_JP
        /// <summary>
        /// 画像のアフィン変換を行う
...
#endif
        public static void WarpAffine(CvArr src, CvArr dst, CvMat map_matrix, Interpolation flags, CvScalar fillval)
        {
            if (src == null)
            ...
            CvInvoke.cvWarpAffine(src.CvPtr, dst.CvPtr, map_matrix.CvPtr, flags, fillval);
        }
        #endregion
...
#endif
        public static void WarpPerspective(CvArr src, CvArr dst, CvMat map_matrix)
        {
            WarpPerspective(src, dst, map_matrix, Interpolation.Linear | Interpolation.FillOutliers);
        }
#if LANG_JP
        /// <summary>
        /// 画像の透視変換を行う.
        ...
        /// <param name="flags">A combination of interpolation method and the optional flags.</param>
#endif
        public static void WarpPerspective(CvArr src, CvArr dst, CvMat map_matrix, Interpolation flags)
        {
            WarpPerspective(src, dst, map_matrix, flags, CvScalar.ScalarAll(0));
        }
#if LANG_JP
        /// <summary>
        /// 画像の透視変換を行う.
        ...
        /// <param name="fillval">A value used to fill outliers. </param>
#endif
        public static void WarpPerspective(CvArr src, CvArr dst, CvMat map_matrix, Interpolation flags, CvScalar fillval)
        {
            if (src == null)
                throw new ArgumentNullException("src");
            if (dst == null)
            ...
            if (map_matrix == null)
                throw new ArgumentNullException("map_matrix");
            CvInvoke.cvWarpPerspective(src.CvPtr, dst.CvPtr, map_matrix.CvPtr, flags, fillval);
        }
        #endregion
        #region Watershed
#if LANG_JP
        ...
        public static void Write(CvFileStorage fs, string name, CvArr ptr, CvAttrList attributes)
        {
            ...
            IntPtr _ptr = (ptr == null) ? IntPtr.Zero : ptr.CvPtr;
            CvInvoke.cvWrite(fs.CvPtr, name, _ptr, attributes);
        }
        #endregion
        #region WriteComment
#if LANG_JP
...
#endif
        public static void WriteComment(CvFileStorage fs, string comment, Boolean eol_comment)
        {
            if (fs == null)
                throw new ArgumentNullException("fs");
            if (comment == null)
                throw new ArgumentNullException("comment");
            CvInvoke.cvWriteComment(fs.CvPtr, comment, eol_comment);
        }
        #endregion
...
#endif
        public static void WriteFileNode(CvFileStorage fs, string new_node_name, CvFileNode node, bool embed)
        {
            if (fs == null)
                throw new ArgumentNullException("fs");
            if (string.IsNullOrEmpty(new_node_name))
                throw new ArgumentNullException("new_node_name");
            if (node == null)
                throw new ArgumentNullException("node");

            CvInvoke.cvWriteFileNode(fs.CvPtr, new_node_name, node.CvPtr, embed);
        }
        #endregion
        #region WriteFrame
#if LANG_JP
