...
namespace OpenCvSharp
{
    public static partial class Cv
    {
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvAvgComp> HaarDetectObjects(CvArr image, CvHaarClassifierCascade cascade, CvMemStorage storage, double scale_factor)
        {
            return HaarDetectObjects(image, cascade, storage, scale_factor, 3, HaarDetectionType.Zero, new CvSize(0, 0));
        }
#if LANG_JP
        /// <summary>
        /// 与えられた画像からオブジェクトを含む様な矩形領域を検出し，それらの領域を矩形の列として返す．
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvAvgComp> HaarDetectObjects(CvArr image, CvHaarClassifierCascade cascade, CvMemStorage storage, double scale_factor, int min_neighbors)
        {
            return HaarDetectObjects(image, cascade, storage, scale_factor, min_neighbors, HaarDetectionType.Zero, new CvSize(0, 0));
        }
#if LANG_JP
        /// <summary>
        /// 与えられた画像からオブジェクトを含む様な矩形領域を検出し，それらの領域を矩形の列として返す．
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvAvgComp> HaarDetectObjects(CvArr image, CvHaarClassifierCascade cascade, CvMemStorage storage, double scale_factor, int min_neighbors, HaarDetectionType flags)
        {
            return HaarDetectObjects(image, cascade, storage, scale_factor, min_neighbors, flags, new CvSize(0, 0));
        }
#if LANG_JP
        /// <summary>
        /// 与えられた画像からオブジェクトを含む様な矩形領域を検出し，それらの領域を矩形の列として返す．
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvAvgComp> HaarDetectObjects(CvArr image, CvHaarClassifierCascade cascade, CvMemStorage storage, double scale_factor, int min_neighbors, HaarDetectionType flags, CvSize min_size)
        {
            if (image == null)
            ...
            IntPtr result = CvInvoke.cvHaarDetectObjects(image.CvPtr, cascade.CvPtr, storage.CvPtr, scale_factor, min_neighbors, flags, min_size);
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvCircleSegment> HoughCircles(CvArr image, CvMemStorage circle_storage, HoughCirclesMethod method, double dp, double min_dist)
        {
            return HoughCircles(image, circle_storage, method, dp, min_dist, 100, 100, 0, 0);
        }
#if LANG_JP
        /// <summary>
        /// ハフ変換を用いてグレースケール画像中の円を検出する
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvCircleSegment> HoughCircles(CvArr image, CvMemStorage circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1)
        {
            return HoughCircles(image, circle_storage, method, dp, min_dist, param1, 100, 0, 0);
        }
#if LANG_JP
        /// <summary>
        /// ハフ変換を用いてグレースケール画像中の円を検出する
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvCircleSegment> HoughCircles(CvArr image, CvMemStorage circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1, double param2)
        {
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvCircleSegment> HoughCircles(CvArr image, CvMemStorage circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1, double param2, int min_radius)
        {
            return HoughCircles(image, circle_storage, method, dp, min_dist, param1, param2, min_radius, 0);
        }
#if LANG_JP
        /// <summary>
        /// ハフ変換を用いてグレースケール画像中の円を検出する
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvCircleSegment> HoughCircles(CvArr image, CvMemStorage circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1, double param2, int min_radius, int max_radius)
        {
            if (image == null)
                throw new ArgumentNullException("image");
            if (circle_storage == null)
                throw new ArgumentNullException("circle_storage");
            IntPtr result = CvInvoke.cvHoughCircles(image.CvPtr, circle_storage.CvPtr, method, dp, min_dist, param1, param2, min_radius, max_radius);
            if (result == IntPtr.Zero)
                return null;
            else
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvCircleSegment> HoughCircles(CvArr image, CvMat circle_storage, HoughCirclesMethod method, double dp, double min_dist)
        {
            return HoughCircles(image, circle_storage, method, dp, min_dist, 100, 100, 0, 0);
        }
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvCircleSegment> HoughCircles(CvArr image, CvMat circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1)
        {
            return HoughCircles(image, circle_storage, method, dp, min_dist, param1, 100, 0, 0);
        }
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvCircleSegment> HoughCircles(CvArr image, CvMat circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1, double param2, int min_radius)
        {
            return HoughCircles(image, circle_storage, method, dp, min_dist, param1, param2, min_radius, 0);
        }
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvCircleSegment> HoughCircles(CvArr image, CvMat circle_storage, HoughCirclesMethod method, double dp, double min_dist, double param1, double param2, int min_radius, int max_radius)
        {
            if (image == null)
                throw new ArgumentNullException("image");
            if (circle_storage == null)
        ...
        /// <returns></returns>
#endif
        public static CvSeq HoughLines2(CvArr image, CvMemStorage line_storage, HoughLinesMethod method, double rho, double theta, int threshold)
        {
            return HoughLines2(image, line_storage, method, rho, theta, threshold, 0, 0);
        }
#if LANG_JP
        /// <summary>
        /// ハフ（Hough）変換を用いて2値画像から直線を検出する
        ...
        /// <returns></returns>
#endif
        public static CvSeq HoughLines2(CvArr image, CvMemStorage line_storage, HoughLinesMethod method, double rho, double theta, int threshold, double param1, double param2)
        {
            if (image == null)
                throw new ArgumentNullException("image");
        ...
        /// <returns></returns>
#endif
        public static CvSeq HoughLines2(CvArr image, CvMat line_storage, HoughLinesMethod method, double rho, double theta, int threshold)
        {
            return HoughLines2(image, line_storage, method, rho, theta, threshold, 0, 0);
        }
#if LANG_JP
