...
namespace OpenCvSharp
{
    public static partial class Cv
    {
        ...
        /// <returns></returns>
#endif
        public static int KMeans2(CvArr samples, int cluster_count, CvArr labels, CvTermCriteria termcrit)
        {
            double compactness;
            return KMeans2(samples, cluster_count, labels, termcrit, 1, null, KMeansFlag.Zero, null, out compactness);
        }
#if LANG_JP
        /// <summary>
        /// ベクトル集合を，与えられたクラスタ数に分割する.
        ...
        /// <returns></returns>
#endif
        public static int KMeans2(CvArr samples, int cluster_count, CvArr labels, CvTermCriteria termcrit, int attemps, CvRNG rng, KMeansFlag flag)
        {
            double compactness;
            return KMeans2(samples, cluster_count, labels, termcrit, attemps, rng, flag, null, out compactness);
        }
#if LANG_JP
        /// <summary>
        /// ベクトル集合を，与えられたクラスタ数に分割する.
