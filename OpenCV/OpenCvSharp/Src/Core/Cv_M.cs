...
namespace OpenCvSharp
{
    public static partial class Cv
    {
        ...
        /// <param name="img_size">画像のサイズ</param>
        ...
        /// <param name="line_count">スキャンライン数を格納する変数へのポインタ</param>
#else
        /// <summary>
...
#endif
        public static void MakeScanlines(double[,] matrix, CvSize img_size, int[] scanlines1, int[] scanlines2, int[] lengths1, int[] lengths2, out int line_count)
        {
            CvInvoke.cvMakeScanlines(matrix, img_size, scanlines1, scanlines2, lengths1, lengths2, out line_count);
        }
        #endregion
        ...
        /// <param name="seq_type">生成するシーケンスのタイプ．</param>
        /// <param name="header_size">シーケンスヘッダのサイズ．パラメータseqは，このヘッダと同じサイズか，これより大きい構造体へのポインタを指していなければならない．</param>
        /// <param name="elem_size">シーケンス要素のサイズ．</param>
        ...
        /// <returns></returns>
#endif
        public static CvSeq MakeSeqHeaderForArray<T>(SeqType seq_type, int header_size, int elem_size, T[] elements, CvSeq seq, CvSeqBlock block) where T : struct
        {
            if (seq == null)
            ...
            {
                IntPtr result = CvInvoke.cvMakeSeqHeaderForArray(seq_type, header_size, elem_size, elementsPtr, total, seq.CvPtr, block.CvPtr);
...
#endif
        public static int MeanShift(CvArr prob_image, CvRect window, CvTermCriteria criteria, CvConnectedComp comp)
        {
            if (prob_image == null)
            {
            ...
            return CvInvoke.cvMeanShift(prob_image.CvPtr, window, criteria, comp.CvPtr);
        }
        #endregion
        ...
        public static CvString MemStorageAllocString(CvMemStorage storage, string str)
        {
            ...
            unsafe
            {
                ...
                {
                    return CvInvoke.cvMemStorageAllocString(storage.CvPtr, str_ptr, str.Length);
                }
            }
        }
        #endregion
...
#endif
        public static void MinMaxLoc(CvArr arr, out double min_val, out double max_val)
        {
            CvPoint min_loc, max_loc;
            MinMaxLoc(arr, out min_val, out max_val, out min_loc, out max_loc, null);
        }
#if LANG_JP
        /// <summary>
        /// 配列あるいは部分配列内の最小値と最大値を求める
...
#endif
        public static void MinMaxLoc(CvArr arr, out double min_val, out double max_val, CvArr mask)
        {
            CvPoint min_loc, max_loc;
            MinMaxLoc(arr, out min_val, out max_val, out min_loc, out max_loc, mask);
        }
#if LANG_JP
        /// <summary>
        /// 配列あるいは部分配列内の最小値と最大値を求める
...
#endif
        public static void MinMaxLoc(CvArr arr, out CvPoint min_loc, out CvPoint max_loc)
        {
        ...
        /// <param name="mask">The optional mask that is used to select a subarray. </param>
#endif
        public static void MinMaxLoc(CvArr arr, out CvPoint min_loc, out CvPoint max_loc, CvArr mask)
        {
            double min_val, max_val;
            MinMaxLoc(arr, out min_val, out max_val, out min_loc, out max_loc, mask);
        }
        ...
        /// <param name="max_loc">Pointer to returned maximum location. </param>
#endif
        public static void MinMaxLoc(CvArr arr, out double min_val, out double max_val, out CvPoint min_loc, out CvPoint max_loc)
        {
            MinMaxLoc(arr, out min_val, out max_val, out min_loc, out max_loc, null);
        }
#if LANG_JP
        ...
        /// <param name="mask">The optional mask that is used to select a subarray. </param>
#endif
        public static void MinMaxLoc(CvArr arr, out double min_val, out double max_val, out CvPoint min_loc, out CvPoint max_loc, CvArr mask)
        {
            if (arr == null)
            {
            ...
            CvInvoke.cvMinMaxLoc(arr.CvPtr, ref min_val, ref max_val, ref min_loc, ref max_loc, maskPtr);
        }
        #endregion
        #region MinAreaRect2
#if LANG_JP
        ...
        /// <param name="from_to">コピーされる平面（チャンネル）のインデックスのペア配列． from_to[k*2]は入力平面の0を基準としたインデックスで，from_to[k*2+1]は出力平面のインデックス．ここで，入力及び出力配列すべてについて，各平面への連続的な番号付けが行われる．from_to[k*2]が負のとき，対応する出力平面は0で埋められる．</param>
#else
        /// <summary>
...
#endif
        public static void MixChannels(CvArr[] src, CvArr[] dst, int[] from_to)
        {
            ...
            if (dst == null || dst.Length == 0)
                throw new ArgumentNullException("dst");
            if (from_to == null)
                throw new ArgumentNullException("from_to");
            ...
            int pair_count = from_to.Length / 2;

            CvInvoke.cvMixChannels(srcPtr, src.Length, dstPtr, dst.Length, from_to, pair_count);
        }
        #endregion
        #region Moments
#if LANG_JP
        ...
        {
            MorphologyEx(src, dst, temp, element, operation);
        }
#if LANG_JP
        /// <summary>
        /// 高度なモルフォロジー変換を実行する.
        ...
        /// <param name="delta">delta, in the code, it compares (size_{i}-size_{i-delta})/size_{i-delta}</param>
#endif
        public static CvMSERParams MSERParams(int delta)
        {
            return new CvMSERParams(delta);
        }
#if LANG_JP
        /// <summary>
        /// MSERのパラメータを生成する
        ...
        /// <param name="min_area">prune the area which smaller than min_area</param>
#endif
        public static CvMSERParams MSERParams(int delta, int min_area)
        {
            return new CvMSERParams(delta, min_area);
        }
#if LANG_JP
        /// <summary>
        /// MSERのパラメータを生成する
        ...
        /// <param name="max_area">prune the area which bigger than max_area</param>
#endif
        public static CvMSERParams MSERParams(int delta, int min_area, int max_area)
        {
            return new CvMSERParams(delta, min_area, max_area);
        }
#if LANG_JP
        /// <summary>
        /// MSERのパラメータを生成する
        ...
        /// <param name="max_variation">prune the area have simliar size to its children</param>
#endif
        public static CvMSERParams MSERParams(int delta, int min_area, int max_area, float max_variation)
        {
            return new CvMSERParams(delta, min_area, max_area, max_variation);
        }
#if LANG_JP
        /// <summary>
        /// MSERのパラメータを生成する
        ...
        /// <param name="min_diversity">trace back to cut off mser with diversity &lt; min_diversity</param>
#endif
        public static CvMSERParams MSERParams(int delta, int min_area, int max_area, float max_variation, float min_diversity)
        {
            return new CvMSERParams(delta, min_area, max_area, max_variation, min_diversity);
        }
#if LANG_JP
        /// <summary>
        /// MSERのパラメータを生成する
        ...
        /// <param name="max_evolution">for color image, the evolution steps</param>
#endif
        public static CvMSERParams MSERParams(int delta, int min_area, int max_area, float max_variation, float min_diversity, int max_evolution)
        {
            return new CvMSERParams(delta, min_area, max_area, max_variation, min_diversity, max_evolution);
        }
#if LANG_JP
        /// <summary>
        /// MSERのパラメータを生成する
        ...
        /// <param name="area_threshold">the area threshold to cause re-initialize</param>
#endif
        public static CvMSERParams MSERParams(int delta, int min_area, int max_area, float max_variation, float min_diversity, int max_evolution, double area_threshold)
        {
            return new CvMSERParams(delta, min_area, max_area, max_variation, min_diversity, max_evolution, area_threshold);
        }
#if LANG_JP
        /// <summary>
        /// MSERのパラメータを生成する
        ...
        /// <param name="min_margin">ignore too small margin</param>
#endif
        public static CvMSERParams MSERParams(int delta, int min_area, int max_area, float max_variation, float min_diversity, int max_evolution, double area_threshold, double min_margin)
        {
            return new CvMSERParams(delta, min_area, max_area, max_variation, min_diversity, max_evolution, area_threshold, min_margin);
        }
#if LANG_JP
        /// <summary>
        /// MSERのパラメータを生成する
        ...
        /// <param name="edge_blur_size">the aperture size for edge blur</param>
#endif
        public static CvMSERParams MSERParams(int delta, int min_area, int max_area, float max_variation, float min_diversity, int max_evolution, double area_threshold, double min_margin, int edge_blur_size)
        {
            return new CvMSERParams(delta, min_area, max_area, max_variation, min_diversity, max_evolution, area_threshold, min_margin, edge_blur_size);
        }
        #endregion
        #region mSet
#if LANG_JP
