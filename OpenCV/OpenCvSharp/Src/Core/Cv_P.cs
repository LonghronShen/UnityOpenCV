...
namespace OpenCvSharp
{
    public static partial class Cv
    {
        ...
        /// </summary>
        /// <param name="seq_kind">点のシーケンスの種類</param>
        /// <param name="mat">入力行列．点の連続的な1次元ベクトルで，CV_32SC2型かCV_32FC2型でなければならない．</param>
        /// <param name="contour_header">輪郭ヘッダ．この関数で初期化される．</param>
...
#endif
        public static CvSeq PointSeqFromMat(SeqType seq_kind, CvArr mat, out CvContour contour_header, out CvSeqBlock block)
        {
            if (mat == null)
            ...
            contour_header = new CvContour();
            block = new CvSeqBlock();
            IntPtr result = CvInvoke.cvPointSeqFromMat(seq_kind, mat.CvPtr, contour_header.CvPtr, block.CvPtr);
        ...
        public static void PolarToCart(CvArr magnitude, CvArr angle, CvArr x, CvArr y, AngleUnit unit)
        {
            ...
            IntPtr x_ptr = (x == null) ? IntPtr.Zero : x.CvPtr;
            IntPtr y_ptr = (y == null) ? IntPtr.Zero : y.CvPtr;
            CvInvoke.cvPolarToCart(magnitude_ptr, angle.CvPtr, x.CvPtr, y.CvPtr, unit);
        }
        #endregion
        #region PolyLine
#if LANG_JP
...
#endif
        public static void PolyLine(CvArr img, CvPoint[][] pts, bool is_closed, CvScalar color)
        {
            PolyLine(img, pts, is_closed, color, 1, LineType.Link8, 0);
        }
#if LANG_JP
        /// <summary>
        /// ポリライン（枠だけのポリゴン）を描画する
...
#endif
        public static void PolyLine(CvArr img, CvPoint[][] pts, bool is_closed, CvScalar color, int thickness)
        {
            PolyLine(img, pts, is_closed, color, thickness, LineType.Link8, 0);
        }
#if LANG_JP
        /// <summary>
        /// ポリライン（枠だけのポリゴン）を描画する
...
#endif
        public static void PolyLine(CvArr img, CvPoint[][] pts, bool is_closed, CvScalar color, int thickness, LineType line_type)
        {
            PolyLine(img, pts, is_closed, color, thickness, line_type, 0);
        }
#if LANG_JP
        /// <summary>
        /// ポリライン（枠だけのポリゴン）を描画する
...
#endif
        public static void PolyLine(CvArr img, CvPoint[][] pts, bool is_closed, CvScalar color, int thickness, LineType line_type, int shift)
        {
            if (img == null)
                throw new ArgumentNullException("img");
            if (pts == null)
            ...
            using (var ptsPtr = new ArrayAddress2<CvPoint>(pts))
            {
                ...
                // 関数呼び出し
                CvInvoke.cvPolyLine(img.CvPtr, ptsPtr.Pointer, npts, pts.Length, is_closed, color, thickness, line_type, shift);
            }
        }
#if LANG_JP
        /// <summary>
        ...
        /// <param name="color">Polyline color. </param>
#endif
        public static void DrawPolyLine(CvArr img, CvPoint[][] pts, bool is_closed, CvScalar color)
        {
            PolyLine(img, pts, is_closed, color, 1, LineType.Link8, 0);
        }
#if LANG_JP
        ...
        /// <param name="thickness">Thickness of the polyline edges. </param>
#endif
        public static void DrawPolyLine(CvArr img, CvPoint[][] pts, bool is_closed, CvScalar color, int thickness)
        {
            PolyLine(img, pts, is_closed, color, thickness, LineType.Link8, 0);
        }
#if LANG_JP
        ...
        /// <param name="line_type">Type of the line segments.</param>
#endif
        public static void DrawPolyLine(CvArr img, CvPoint[][] pts, bool is_closed, CvScalar color, int thickness, LineType line_type)
        {
            PolyLine(img, pts, is_closed, color, thickness, line_type, 0);
        }
#if LANG_JP
        ...
        /// <param name="shift">Number of fractional bits in the vertex coordinates. </param>
#endif
        public static void DrawPolyLine(CvArr img, CvPoint[][] pts, bool is_closed, CvScalar color, int thickness, LineType line_type, int shift)
        {
            PolyLine(img, pts, is_closed, color, thickness, line_type, shift);
        }
        #endregion
        #region POSIT
#if LANG_JP
        ...
        /// POSITアルゴリズムの実装
        /// </summary>
        /// <param name="posit_object">オブジェクト構造体</param>
...
#endif
        public static void POSIT(CvPOSITObject posit_object, CvPoint2D32f[] image_points, double focal_length,
              CvTermCriteria criteria, out float[,] rotation_matrix, out float[] translation_vector)
        {
            if (posit_object == null)
                throw new ArgumentNullException("posit_object");
            rotation_matrix = new float[3, 3];
            translation_vector = new float[3];
            CvInvoke.cvPOSIT(posit_object.CvPtr, image_points, focal_length, criteria, rotation_matrix, translation_vector);
        }
        #endregion
...
#endif
        public static void PreCornerDetect(CvArr image, CvArr corners, ApertureSize aperture_size)
        {
            if (image == null)
                throw new ArgumentNullException("image");
            if (corners == null)
                throw new ArgumentNullException("corners");
            CvInvoke.cvPreCornerDetect(image.CvPtr, corners.CvPtr, aperture_size);
        }
        #endregion
        #region PrevTreeNode
#if LANG_JP
        ...
        /// </summary>
        /// <param name="tree_iterator">初期化されるツリーのイテレータ</param>
        /// <returns></returns>
#else
        /// <summary>
        ...
        /// <returns></returns>
#endif
        public static IntPtr PrevTreeNode(CvTreeNodeIterator tree_iterator)
        {
            if (tree_iterator == null)
            {
                throw new ArgumentNullException("tree_iterator");
            }
            return CvInvoke.cvPrevTreeNode(tree_iterator);
        }
#if LANG_JP
        /// <summary>
        /// 現在のノードを返し，イテレータを前のノードに移動させる．
        ...
        /// <returns></returns>
#endif
        public static T PrevTreeNode<T>(CvTreeNodeIterator tree_iterator) where T : CvArr
        {
            if (tree_iterator == null)
            {
                throw new ArgumentNullException("tree_iterator");
            }
            IntPtr result = CvInvoke.cvPrevTreeNode(tree_iterator);
            if (result == IntPtr.Zero)
            {
                return null;
            }
        ...
        /// <returns></returns>
#endif
        public static T PrevTreeNode<T>(CvTreeNodeIterator<T> tree_iterator) where T : CvArr
        {
            return PrevTreeNode<T>((CvTreeNodeIterator)tree_iterator);
        }
        #endregion
        #region ProjectPCA
#if LANG_JP
        ...
        /// </remarks>
        /// <param name="object_points">オブジェクトの点の配列でその大きさは3xNまたはNx3である．N は画像内の点の個数</param>
        /// <param name="rotation_vector">回転ベクトル．1x3または3x1</param>
        /// <param name="translation_vector">並進ベクトル．1x3または3x1</param>
        /// <param name="intrinsic_matrix">カメラマトリクス(A) [fx 0 cx; 0 fy cy; 0 0 1]</param>
        /// <param name="distortion_coeffs">歪み係数．4x1または1x4 [k1, k2, p1, p2]. NULLの場合，すべての歪み係数を0とする</param>
        /// <param name="image_points">画像平面上の点の出力配列で，その大きさは2xNまたはNx2である．ここでNはビュー上の点の数</param>
#else
        /// <summary>
...
#endif   
        public static void ProjectPoints2(CvMat object_points, CvMat rotation_vector, CvMat translation_vector, CvMat intrinsic_matrix, CvMat distortion_coeffs, CvMat image_points)
        {
            ProjectPoints2(object_points, rotation_vector, translation_vector, intrinsic_matrix, distortion_coeffs, image_points, null, null, null, null, null, 0);
        }
#if LANG_JP
        /// <summary>
        /// 次元空間中の点を画像平面上に投影した際の座標を，内部パラメータと外部パラメータを用いて計算する．
...
#endif
        public static void ProjectPoints2(CvMat object_points, CvMat rotation_vector, CvMat translation_vector, CvMat intrinsic_matrix, CvMat distortion_coeffs, CvMat image_points, CvMat dpdrot, CvMat dpdt, CvMat dpdf, CvMat dpdc, CvMat dpddist)
        {
            ProjectPoints2(object_points, rotation_vector, translation_vector, intrinsic_matrix, distortion_coeffs, image_points, dpdrot, dpdt, dpdf, dpdc, dpddist, 0);
        }
#if LANG_JP
        /// <summary>
        /// 次元空間中の点を画像平面上に投影した際の座標を，内部パラメータと外部パラメータを用いて計算する．
        ...
        /// <param name="aspect_ratio"></param>
#endif
        public static void ProjectPoints2(CvMat object_points, CvMat rotation_vector, CvMat translation_vector, CvMat intrinsic_matrix, CvMat distortion_coeffs, CvMat image_points, CvMat dpdrot, CvMat dpdt, CvMat dpdf, CvMat dpdc, CvMat dpddist, double aspect_ratio)
        {
            ...
            IntPtr distortion_coeffs_ptr = (distortion_coeffs == null) ? IntPtr.Zero : distortion_coeffs.CvPtr;
            ...
            CvInvoke.cvProjectPoints2(object_points.CvPtr, rotation_vector.CvPtr, translation_vector.CvPtr, intrinsic_matrix.CvPtr, distortion_coeffs.CvPtr, image_points.CvPtr, dpdrotPtr, dpdtPtr, dpdfPtr, dpdcPtr, dpddistPtr, aspect_ratio);
        }
        #endregion
        #region Ptr*D
#if LANG_JP
        ...
        /// <returns>pointer to the particular array element</returns>
#endif
        public static IntPtr PtrND(CvArr arr, int[] idx, out MatrixType type, bool create_node)
        {
            return CvInvoke.cvPtrND(arr.CvPtr, idx, out type, create_node, IntPtr.Zero);
        }
#if LANG_JP
        /// <summary>
        /// 特定の配列要素へのポインタを返す．
        ...
        /// <returns>pointer to the particular array element</returns>
#endif
        public static IntPtr PtrND(CvArr arr, int[] idx, out MatrixType type, bool create_node, uint? precalc_hashval)
        {
            if (precalc_hashval.HasValue)
            {
                return CvInvoke.cvPtrND(arr.CvPtr, idx, out type, create_node, IntPtr.Zero);
            }
            else
            {
                using (StructurePointer<uint> precalc_hashval_ptr = new StructurePointer<uint>(precalc_hashval.Value))
                {
                    return CvInvoke.cvPtrND(arr.CvPtr, idx, out type, create_node, precalc_hashval_ptr);
                }
            }
        }
        #endregion
...
#endif
        public static void PyrMeanShiftFiltering(CvArr src, CvArr dst, double sp, double sr, int max_level)
        {
            PyrMeanShiftFiltering(src, dst, sp, sr, max_level, new CvTermCriteria(CriteriaType.Iteration | CriteriaType.Epsilon, 5, 1));
        }
#if LANG_JP
        /// <summary>
        /// 平均値シフト法による画像のセグメント化アルゴリズムのフィルタリング部分を実装する．
...
#endif
        public static void PyrMeanShiftFiltering(CvArr src, CvArr dst, double sp, double sr, int max_level, CvTermCriteria termcrit)
        {
            if (src == null)
                throw new ArgumentNullException("src");
            if (dst == null)
                throw new ArgumentNullException("dst");
            CvInvoke.cvPyrMeanShiftFiltering(src.CvPtr, dst.CvPtr, sp, sr, max_level, termcrit);
        }
        #endregion
