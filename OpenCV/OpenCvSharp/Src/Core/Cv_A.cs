...
namespace OpenCvSharp
{
    public static partial class Cv
    {
...
#endif
        public static void AdaptiveThreshold(CvArr src, CvArr dst, double max_value)
        {
            AdaptiveThreshold(src, dst, max_value, AdaptiveThresholdType.MeanC, ThresholdType.Binary, 3, 5);
        }
#if LANG_JP
        /// <summary>
        /// 適応的な閾値処理を行い、グレースケール画像を2値画像に変換する
...
#endif
        public static void AdaptiveThreshold(CvArr src, CvArr dst, double max_value, AdaptiveThresholdType adaptive_method)
        {
            AdaptiveThreshold(src, dst, max_value, adaptive_method, ThresholdType.Binary, 3, 5);
        }
#if LANG_JP
        /// <summary>
        /// 適応的な閾値処理を行い、グレースケール画像を2値画像に変換する
...
#endif
        public static void AdaptiveThreshold(CvArr src, CvArr dst, double max_value, AdaptiveThresholdType adaptive_method, ThresholdType threshold_type)
        {
            AdaptiveThreshold(src, dst, max_value, adaptive_method, threshold_type, 3, 5);
        }
#if LANG_JP
        /// <summary>
        /// 適応的な閾値処理を行い、グレースケール画像を2値画像に変換する
        ...
        /// </summary>
        /// <param name="src_seq">他のチェーンから参照可能なチェーンへの参照．</param>
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvPoint> ApproxChains(CvChain src_seq, CvMemStorage storage)
        {
            return ApproxChains(src_seq, storage, ContourChain.ApproxSimple, 0, 0, false);
        }
#if LANG_JP
        /// <summary>
        /// フリーマンチェーン（Freeman chain）をポリラインで近似する
        ...
        /// /// <returns></returns>
#endif
        public static CvSeq<CvPoint> ApproxChains(CvChain src_seq, CvMemStorage storage, ContourChain method)
        {
            return ApproxChains(src_seq, storage, method, 0, 0, false);
        }
#if LANG_JP
        /// <summary>
        /// フリーマンチェーン（Freeman chain）をポリラインで近似する
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvPoint> ApproxChains(CvChain src_seq, CvMemStorage storage, ContourChain method, double parameter)
        {
            return ApproxChains(src_seq, storage, method, parameter, 0, false);
        }
#if LANG_JP
        /// <summary>
        /// フリーマンチェーン（Freeman chain）をポリラインで近似する
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvPoint> ApproxChains(CvChain src_seq, CvMemStorage storage, ContourChain method, double parameter, int minimal_perimeter)
        {
            return ApproxChains(src_seq, storage, method, parameter, minimal_perimeter, false);
        }
#if LANG_JP
        /// <summary>
        /// フリーマンチェーン（Freeman chain）をポリラインで近似する
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvPoint> ApproxChains(CvChain src_seq, CvMemStorage storage, ContourChain method, double parameter, int minimal_perimeter, bool recursive)
        {
            if (src_seq == null)
                throw new ArgumentNullException("image");
            if (storage == null)
                throw new ArgumentNullException("storage");
            IntPtr result_ptr = CvInvoke.cvApproxChains(src_seq.CvPtr, storage.CvPtr, method, parameter, minimal_perimeter, recursive);
            ...
            {
                CvSeq<CvPoint> result = new CvSeq<CvPoint>(result_ptr);
                return result;
            }
        }
        #endregion
        ...
        /// 指定した精度でポリラインを近似する
        /// </summary>
        /// <param name="src_seq">点のシーケンスまたは配列</param>
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvPoint> ApproxPoly(CvSeq<CvPoint> src_seq, int header_size, CvMemStorage storage, ApproxPolyMethod method, double parameter)
        {
            return ApproxPoly(src_seq, header_size, storage, method, parameter, false);
        }
#if LANG_JP
        /// <summary>
        /// 指定した精度でポリラインを近似する
        ...
        /// <returns></returns>
#endif
        public static CvSeq<CvPoint> ApproxPoly(CvSeq<CvPoint> src_seq, int header_size, CvMemStorage storage, ApproxPolyMethod method, double parameter, bool parameter2)
        {
            if (src_seq == null)
            {
                throw new ArgumentNullException("src_seq");
            }
            IntPtr storagePtr = (storage == null) ? IntPtr.Zero : storage.CvPtr;
            IntPtr result = CvInvoke.cvApproxPoly(src_seq.CvPtr, header_size, storagePtr, method, parameter, parameter2);
        ...
        /// <returns></returns>
#endif
        public static double ArcLength(CvArr curve, CvSlice slice, int is_closed)
        {
            if (curve == null)
            {
                throw new ArgumentNullException("curve");
            }
            return CvInvoke.cvArcLength(curve.CvPtr, slice, is_closed);
        }
        #endregion
        #region AttrList
#if LANG_JP
...
#endif
        public static void AvgSdv(CvArr arr, out CvScalar mean, out CvScalar std_dev)
        {
            AvgSdv(arr, out mean, out std_dev, null);
        }
#if LANG_JP
        /// <summary>
        /// 配列要素の平均と標準偏差を各チャンネルで独立に計算する．
        ...
        /// <param name="mask">The optional operation mask. </param>
#endif
        public static void AvgSdv(CvArr arr, out CvScalar mean, out CvScalar std_dev, CvArr mask)
        {
            if (arr == null)
            {
                throw new ArgumentNullException("arr");
            ...
            mean = new CvScalar();
            std_dev = new CvScalar();
            IntPtr maskPtr = (mask == null) ? IntPtr.Zero : mask.CvPtr;
            CvInvoke.cvAvgSdv(arr.CvPtr, ref mean, ref std_dev, maskPtr);
        }
        #endregion
    }
}